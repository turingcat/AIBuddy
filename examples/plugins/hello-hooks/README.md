...
A tiny [Open Plugins](https://open-plugins.com) plugin that demonstrates aibuddy's
...
AIBuddy discovers plugins under `~/.agents/plugins/<name>/` (user scope) and
...
# Then run aibuddy normally; you should see lines like
