...
export const HEYBUDDY_EXT_METHODS = [
  ...
  {
    method: "_heybuddy/unstable/config/extensions/add",
    requestType: "AddConfigExtensionRequest_unstable",
    responseType: "EmptyResponse",
  },
  {
    method: "_heybuddy/unstable/config/extensions/remove",
  ...
  {
    method: "_heybuddy/unstable/schedules/delete",
    requestType: "DeleteScheduleRequest_unstable",
    responseType: "EmptyResponse",
  },
  {
    method: "_heybuddy/unstable/schedules/pause",
  ...
  {
    method: "_heybuddy/unstable/dictation/models/download",
  ...
  {
    method: "_heybuddy/unstable/dictation/models/cancel",
    requestType: "DictationModelCancelRequest_unstable",
    responseType: "EmptyResponse",
  },
  {
    method: "_heybuddy/unstable/dictation/models/delete",
...
export const HEYBUDDY_EXT_NOTIFICATIONS = [
  {
    method: "_heybuddy/unstable/session/update",
    paramsType: "HeyBuddySessionNotification_unstable",
  },
  {
    method: "_heybuddy/unstable/providers/authentication/device-code",
    paramsType: "ProviderDeviceCodeNotification_unstable",
  },
] as const;

export type HeyBuddyExtNotification =
  (typeof HEYBUDDY_EXT_NOTIFICATIONS)[number];

export const HEYBUDDY_EXT_AGENT_REQUESTS = [
  {
...
export type HeyBuddyExtAgentRequest =
  (typeof HEYBUDDY_EXT_AGENT_REQUESTS)[number];
