 ...
 */
export type AIBuddyToolCallRequest_unstable = {
    sessionId: string;
    name: string;
    arguments?: unknown;
};
 ...
 * Tool call response.
 */
export type AIBuddyToolCallResponse_unstable = {
...
export type GetConfigExtensionsResponse_unstable = {
    extensions: Array<AIBuddyExtensionEntry>;
    warnings?: Array<string>;
};

export type AIBuddyExtensionEntry = {
    extension: AIBuddyExtension;
    enabled: boolean;
...
export type PreferenceKey = 'autoCompactThreshold' | 'aibuddyThinkingEffort' | 'voiceAutoSubmitPhrases' | 'voiceDictationProvider' | 'voiceDictationPreferredMic';
 ...
 */
export type OnboardingImportSourceKind = 'aibuddy_config' | 'claude_desktop';
...
export type RecipeSettingsDto = {
    aibuddy_provider?: string | null;
    aibuddy_model?: string | null;
 ...
 */
export type AIBuddySessionNotification_unstable = {
    sessionId: string;
    update: AIBuddySessionUpdate;
};
 ...
 */
export type AIBuddySessionUpdate = ({
...
export type ExtNotification = {
    method: string;
    params?: AIBuddySessionNotification_unstable | ProviderDeviceCodeNotification_unstable | {
        [key: string]: unknown;
    } | null;
};
