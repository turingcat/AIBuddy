...
export class AIBuddyExtClient {
  ...
  async sessionExtensionsAdd_unstable(
    ...
    await this.conn.request("_aibuddy/unstable/session/extensions/add", params);
  }
  ...
  async toolsList_unstable(
    ...
    const raw = await this.conn.request("_aibuddy/unstable/tools/list", params);
  ...
  async toolsCall_unstable(
    ...
    const raw = await this.conn.request("_aibuddy/unstable/tools/call", params);
  ...
  async sessionProjectUpdate_unstable(
    ...
    await this.conn.request("_aibuddy/unstable/session/project/update", params);
  }
