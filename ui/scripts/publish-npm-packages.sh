...
release_version="$2"
packages=(
  @aibuddy/aibuddy-binary-darwin-arm64
  @aibuddy/aibuddy-binary-linux-arm64
  @aibuddy/aibuddy-binary-linux-x64
  @aibuddy/aibuddy-binary-win32-x64
  @aibuddy/aibuddy-acp
...
publish_package() {
  ...
  local tarball="$package_dir/aibuddy-${package_name#@aibuddy/}-$release_version.tgz"
