...
const i18n = defineMessages({
  ...
  heybuddyWouldLikeToCallWithName: {
    id: 'toolConfirmation.heybuddyWouldLikeToCallWithName',
...
export default function ToolConfirmation({
  ...
  return (
    <div className="heybuddy-message-content bg-background-primary border border-border-primary rounded-2xl overflow-hidden">
      <div className="bg-background-secondary px-4 py-2 text-text-primary">
        {prompt
          ...
          : intl.formatMessage(i18n.heybuddyWouldLikeToCallWithName, { toolName: displayName })}
      </div>
