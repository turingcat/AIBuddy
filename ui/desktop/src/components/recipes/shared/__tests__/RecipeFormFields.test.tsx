    ...
    it('pre-fills subrecipes from initial values', async () => {
      ...
      const initialValues: Partial<RecipeFormData> = {
        subRecipes: [
          {
            name: 'data_fetcher',
            path: '~/.config/aibuddy/recipes/abc123.yaml',
      ...
      expect(screen.getByText('~/.config/aibuddy/recipes/abc123.yaml')).toBeInTheDocument();
        ...
        subRecipes: [
          {
            ...
            path: '~/.config/aibuddy/recipes/def456.yaml',
            sequential_when_repeated: false,
        ...
        subRecipes: [
          {
            ...
            path: '~/.config/aibuddy/recipes/ghi789.yaml',
    ...
    it('removes a subrecipe when its delete button is clicked', async () => {
      ...
      const initialValues: Partial<RecipeFormData> = {
        subRecipes: [
          {
            name: 'to_be_deleted',
            path: '~/.config/aibuddy/recipes/jkl012.yaml',
            sequential_when_repeated: false,
          },
        ],
      };
