...
import { AIBuddy } from '../icons/AIBuddy';
  ...
  return (
    <div className="flex h-screen w-full flex-col items-center justify-center bg-background-primary px-4">
      <Card className="w-full max-w-sm p-6">
        <AIBuddy className="mx-auto mb-4 size-10" />
        <h1 className="mb-1 text-center text-xl font-light text-text-primary">登录 AIBuddy</h1>
