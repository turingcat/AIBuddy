...
const i18n = defineMessages({
  ...
  description: {
    ...
    defaultMessage: 'Anonymous usage data helps us understand how HeyBuddy is used and identify areas for improvement.',
  },
  whatWeCollect: {
  ...
  collectVersion: {
    ...
    defaultMessage: 'HeyBuddy version and install method',
  },
  collectProvider: {
