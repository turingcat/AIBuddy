...
const i18n = defineMessages({
  ...
  allSet: {
    ...
    defaultMessage: "You're all set to start using HeyBuddy.",
  },
  privacyTitle: {
  ...
  privacyDescription: {
    ...
    defaultMessage: 'Anonymous usage data helps improve HeyBuddy. We never collect your conversations, code, or personal data.',
  },
  learnMore: {
