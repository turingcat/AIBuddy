...
const i18n = defineMessages({
  ...
  promptEditingDescription: {
    ...
    defaultMessage:
      "Customize the prompts that define {appName}'s behavior in different contexts. These prompts use Jinja2 templating syntax. Be careful when modifying template variables, as incorrect changes can break functionality. Please share any improvements with the community.",
  },
  resetAll: {
