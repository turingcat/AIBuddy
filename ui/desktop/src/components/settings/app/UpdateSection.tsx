...
const i18n = defineMessages({
  ...
  disableAutoDownloadDesc: {
    ...
    defaultMessage:
      'When enabled, HeyBuddy will notify you of new versions but will not download them automatically.',
  },
  ...
  autoDownload: {
    ...
    defaultMessage:
      'HeyBuddy will download the update in the background and install it the next time you quit or restart.',
  },
  manualInstallNote: {
  ...
  readyInstallAuto: {
    ...
    defaultMessage:
      "✓ Update is ready. Restart HeyBuddy to finish installing it, or quit when you're done.",
  },
  installNowHint: {
