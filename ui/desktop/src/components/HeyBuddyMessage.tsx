...
interface HeyBuddyMessageProps {
  sessionId: string;
  message: Message;
...
function HeyBuddyMessage({
  ...
  return (
    <div className="heybuddy-message flex w-[90%] justify-start min-w-0">
            ...
            <div className="relative flex flex-col w-full group">
              <div className="flex flex-col gap-3">
                {toolRequests.map((toolRequest, toolIndex) => {
                  ...
                  return (
                    <div className="heybuddy-message-tool" key={toolRequest.id}>
                      <ToolCallWithResponse
                        sessionId={sessionId}
                        isCancelledMessage={toolState.isCancelled}
...
export default memo(HeyBuddyMessage);
