...
function AIBuddyMessage({
  ...
  return (
    <div className="aibuddy-message flex w-[90%] justify-start min-w-0">
            ...
            <div className="relative flex flex-col w-full group">
              <div className="flex flex-col gap-3">
                {toolRequests.map((toolRequest, toolIndex) => {
                  ...
                  return (
                    <div className="aibuddy-message-tool" key={toolRequest.id}>
...
export default memo(AIBuddyMessage);
