...
export class GitHubUpdater {
  ...
  private readonly bundleName = process.env.GOOSE_BUNDLE_NAME || 'HeyBuddy';
    ...
    try {
      ...
      const response = await fetch(this.apiUrl, {
        headers: {
          ...
          'User-Agent': `HeyBuddy-Desktop/${app.getVersion()}`,
        },
      ...
      const asset = release.assets.find((a) => a.name.toLowerCase() === assetName.toLowerCase()); // keeping comparison to lowercase because HeyBuddy vs heybuddy
      if (asset) {
