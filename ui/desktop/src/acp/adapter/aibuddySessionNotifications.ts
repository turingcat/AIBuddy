...
export function applyAIBuddySessionNotification(
  state: AdapterState,
...
function applyStatusMessage(
  state: AdapterState,
  sessionId: string,
  update: Extract<AIBuddySessionNotification_unstable['update'], { sessionUpdate: 'status_message' }>
): AcpChatStateChange[] {
...
function applyMessageUsage(
  state: AdapterState,
  update: Extract<AIBuddySessionNotification_unstable['update'], { sessionUpdate: 'message_usage' }>
): AcpChatStateChange[] {
