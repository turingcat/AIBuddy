...
export function applyHeyBuddySessionNotification(
  state: AdapterState,
...
function applyStatusMessage(
  state: AdapterState,
  sessionId: string,
  update: Extract<HeyBuddySessionNotification_unstable['update'], { sessionUpdate: 'status_message' }>
): AcpChatStateChange[] {
...
function applyMessageUsage(
  state: AdapterState,
  update: Extract<HeyBuddySessionNotification_unstable['update'], { sessionUpdate: 'message_usage' }>
): AcpChatStateChange[] {
