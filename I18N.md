# Internationalization (i18n) — AIBuddy Desktop UI

This document describes the i18n infrastructure for the AIBuddy Desktop UI (`ui/desktop/`).
...
2. **`AIBUDDY_LOCALE`** — explicit override from env/app config when the desktop setting is
   System Default
