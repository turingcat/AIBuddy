...
async function fixture(t) {
  ...
  for (const name of ['cli.mjs', 'package.json', 'package-lock.json', 'brand-map.json', 'production-policy.json', 'text-policy.json', 'map.json', 'map.schema.json', 'src/adapter.mjs', 'rust-parser/Cargo.toml', 'rust-parser/Cargo.lock', 'rust-parser/src/main.rs']) {
...
test('tool identity pins implementation, policy, dependencies and input mode', async (t) => {
  ...
  for (const file of ['src/adapter.mjs', 'brand-map.json', 'production-policy.json', 'package-lock.json', 'map.json', 'map.schema.json', 'text-policy.json', 'rust-parser/Cargo.lock', 'rust-parser/src/main.rs']) {
