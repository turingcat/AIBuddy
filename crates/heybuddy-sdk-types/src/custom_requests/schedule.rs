...
#[request(
    method = "_heybuddy/unstable/schedules/list",
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_heybuddy/unstable/schedules/create",
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_heybuddy/unstable/schedules/delete", response = EmptyResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_heybuddy/unstable/schedules/update",
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_heybuddy/unstable/schedules/run-now",
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_heybuddy/unstable/schedules/sessions/list",
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_heybuddy/unstable/schedules/pause", response = EmptyResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_heybuddy/unstable/schedules/unpause",
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_heybuddy/unstable/schedules/running-job/kill",
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_heybuddy/unstable/schedules/running-job/inspect",
