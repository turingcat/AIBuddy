...
pub const REQUEST_RECIPE_PARAMS_METHOD: &str = "_heybuddy/unstable/session/recipe/request-params";
...
pub struct RecipeSettingsDto {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub heybuddy_provider: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub heybuddy_model: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
#[request(
    method = "_heybuddy/unstable/recipes/encode",
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_heybuddy/unstable/recipes/decode",
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_heybuddy/unstable/recipes/scan", response = ScanRecipeResponse)]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_heybuddy/unstable/recipes/save", response = SaveRecipeResponse)]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_heybuddy/unstable/recipes/parse", response = ParseRecipeResponse)]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_heybuddy/unstable/recipes/delete", response = EmptyResponse)]
pub struct DeleteRecipeRequest {
    pub id: String,
}

#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_heybuddy/unstable/recipes/list", response = ListRecipesResponse)]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_heybuddy/unstable/recipes/schedule", response = EmptyResponse)]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_heybuddy/unstable/recipes/slash-command",
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_heybuddy/unstable/recipes/to-yaml",
