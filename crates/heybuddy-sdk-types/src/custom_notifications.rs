...
#[notification(method = "_heybuddy/unstable/session/update")]
#[serde(rename_all = "camelCase")]
pub struct HeyBuddySessionNotification {
    pub session_id: String,
    pub update: HeyBuddySessionUpdate,
}
...
pub enum HeyBuddySessionUpdate {
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcNotification)]
#[notification(method = "_heybuddy/unstable/providers/authentication/device-code")]
#[serde(rename_all = "camelCase")]
...
impl Default for HeyBuddySessionUpdate {
    fn default() -> Self {
        HeyBuddySessionUpdate::UsageUpdate(SessionUsageUpdate::default())
    }
}
...
/// Schemas for every heybuddy-custom outbound notification. To register a new
...
pub fn custom_notification_schemas(generator: &mut SchemaGenerator) -> Vec<CustomMethodSchema> {
    vec![
        notification_schema::<HeyBuddySessionNotification>(generator),
...
mod tests {
    ...
    fn status_message_serializes_to_expected_wire_shape() {
        let notification = HeyBuddySessionNotification {
    ...
    fn message_usage_serializes_to_expected_wire_shape() {
        let notification = HeyBuddySessionNotification {
            session_id: "s1".to_string(),
            update: HeyBuddySessionUpdate::MessageUsage(MessageUsageUpdate {
