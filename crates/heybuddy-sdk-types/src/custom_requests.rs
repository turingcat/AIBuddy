...
#[request(method = "_heybuddy/unstable/session/extensions/add", response = EmptyResponse)]
#[serde(rename_all = "camelCase")]
pub struct AddSessionExtensionRequest {
    pub session_id: String,
    pub extension: HeyBuddyExtension,
}

/// Remove an extension from an active session.
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_heybuddy/unstable/session/extensions/remove", response = EmptyResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_heybuddy/unstable/tools/list", response = GetToolsResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_heybuddy/unstable/resources/read", response = ReadResourceResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_heybuddy/unstable/tools/call", response = HeyBuddyToolCallResponse)]
#[serde(rename_all = "camelCase")]
pub struct HeyBuddyToolCallRequest {
    pub session_id: String,
    pub name: String,
    #[serde(default)]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcResponse)]
#[serde(rename_all = "camelCase")]
pub struct HeyBuddyToolCallResponse {
    #[serde(default)]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_heybuddy/unstable/apps/list", response = AppsListResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_heybuddy/unstable/apps/export", response = AppsExportResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_heybuddy/unstable/apps/import", response = AppsImportResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_heybuddy/unstable/apps/delete", response = AppsDeleteResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_heybuddy/unstable/session/working-dir/update", response = EmptyResponse)]
#[serde(rename_all = "camelCase")]
...
pub enum SessionSystemPromptMode {
    /// Replace HeyBuddy's base system prompt with the provided text.
    Set,
    /// Append the provided text under HeyBuddy's "Additional Instructions" section.
    #[default]
    Append,
}
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_heybuddy/unstable/session/system-prompt/set",
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_heybuddy/unstable/session/steer",
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_heybuddy/unstable/diagnostics/get",
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_heybuddy/unstable/config/prompts/list", response = ListPromptsResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_heybuddy/unstable/config/prompts/get", response = GetPromptResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_heybuddy/unstable/config/prompts/save", response = PromptOperationResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_heybuddy/unstable/config/prompts/reset", response = PromptOperationResponse)]
#[serde(rename_all = "camelCase")]
...
impl Default for HeyBuddyExtension {
    fn default() -> Self {
        Self::Builtin {
            name: String::new(),
            description: None,
...
#[derive(Debug, Clone, Serialize, Deserialize, JsonSchema)]
#[serde(rename_all = "camelCase")]
pub struct HeyBuddyExtensionEntry {
    pub extension: HeyBuddyExtension,
    pub enabled: bool,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_heybuddy/unstable/config/extensions/list",
...
pub struct GetConfigExtensionsResponse {
    pub extensions: Vec<HeyBuddyExtensionEntry>,
    #[serde(default)]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_heybuddy/unstable/config/extensions/add", response = EmptyResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_heybuddy/unstable/config/extensions/remove", response = EmptyResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_heybuddy/unstable/config/extensions/set-enabled",
    response = EmptyResponse
)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_heybuddy/unstable/session/extensions/list", response = GetSessionExtensionsResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_heybuddy/unstable/preferences/read", response = PreferencesReadResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_heybuddy/unstable/preferences/save", response = EmptyResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_heybuddy/unstable/config/read", response = ConfigReadResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_heybuddy/unstable/config/upsert", response = EmptyResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_heybuddy/unstable/config/remove", response = EmptyResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_heybuddy/unstable/config/read-all", response = ConfigReadAllResponse)]
#[serde(rename_all = "camelCase")]
...
pub enum PreferenceKey {
    ...
    #[serde(rename = "heybuddyThinkingEffort")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_heybuddy/unstable/defaults/read", response = DefaultsReadResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_heybuddy/unstable/defaults/save", response = DefaultsReadResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_heybuddy/unstable/defaults/clear", response = DefaultsReadResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_heybuddy/unstable/onboarding/import/scan",
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_heybuddy/unstable/onboarding/import/apply",
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_heybuddy/unstable/session/info",
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_heybuddy/unstable/session/conversation/truncate",
    response = EmptyResponse
)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_heybuddy/unstable/session/project/update", response = EmptyResponse)]
#[serde(rename_all = "camelCase")]
...
/// Rename a session.
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_heybuddy/unstable/session/rename", response = EmptyResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_heybuddy/unstable/session/archive", response = EmptyResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_heybuddy/unstable/session/unarchive", response = EmptyResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_heybuddy/unstable/session/export", response = ExportSessionResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_heybuddy/unstable/session/import", response = ImportSessionResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_heybuddy/unstable/session/share/nostr",
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_heybuddy/unstable/providers/config/read",
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_heybuddy/unstable/providers/config/status",
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_heybuddy/unstable/providers/config/save",
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_heybuddy/unstable/providers/config/delete",
    response = ProviderConfigChangeResponse
)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_heybuddy/unstable/providers/config/authenticate",
    response = ProviderConfigChangeResponse
)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_heybuddy/unstable/providers/secrets/list",
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_heybuddy/unstable/providers/secrets/delete",
    response = EmptyResponse
)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_heybuddy/unstable/providers/canonical-model-info",
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_heybuddy/unstable/providers/catalog/list",
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_heybuddy/unstable/providers/setup/catalog/list",
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_heybuddy/unstable/providers/catalog/template",
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_heybuddy/unstable/providers/custom/create",
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_heybuddy/unstable/providers/custom/read",
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_heybuddy/unstable/providers/custom/update",
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_heybuddy/unstable/providers/custom/delete",
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_heybuddy/unstable/sources/create", response = CreateSourceResponse)]
#[serde(rename_all = "camelCase")]
...
/// skills.
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_heybuddy/unstable/sources/list", response = ListSourcesResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_heybuddy/unstable/agent-mentions/list",
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_heybuddy/unstable/slash-commands/list",
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_heybuddy/unstable/sources/update", response = UpdateSourceResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_heybuddy/unstable/sources/delete", response = EmptyResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_heybuddy/unstable/sources/export", response = ExportSourceResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_heybuddy/unstable/sources/import", response = ImportSourcesResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_heybuddy/unstable/dictation/transcribe", response = DictationTranscribeResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_heybuddy/unstable/dictation/config", response = DictationConfigResponse)]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_heybuddy/unstable/providers/list", response = ListProvidersResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_heybuddy/unstable/providers/readiness/check",
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_heybuddy/unstable/providers/supported-models/list",
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_heybuddy/unstable/providers/inventory/refresh",
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_heybuddy/unstable/local-inference/models/list",
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_heybuddy/unstable/local-inference/models/download",
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_heybuddy/unstable/local-inference/models/download/progress",
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_heybuddy/unstable/local-inference/models/download/cancel",
    response = EmptyResponse
)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_heybuddy/unstable/local-inference/models/delete",
    response = EmptyResponse
)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_heybuddy/unstable/local-inference/models/evict",
    response = EmptyResponse
)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_heybuddy/unstable/local-inference/models/settings/read",
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_heybuddy/unstable/local-inference/models/settings/update",
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_heybuddy/unstable/local-inference/huggingface/search",
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_heybuddy/unstable/local-inference/huggingface/repo/variants",
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_heybuddy/unstable/local-inference/chat-templates/builtin/list",
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_heybuddy/unstable/dictation/models/list",
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_heybuddy/unstable/dictation/models/download", response = EmptyResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_heybuddy/unstable/dictation/models/download/progress",
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_heybuddy/unstable/dictation/models/cancel", response = EmptyResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_heybuddy/unstable/dictation/models/delete", response = EmptyResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_heybuddy/unstable/tools/permissions/set", response = SetToolPermissionsResponse)]
#[serde(rename_all = "camelCase")]
...
mod tests {
    ...
    #[test]
    fn preference_key_preserves_heybuddy_wire_casing() {
        let key = serde_json::to_string(&PreferenceKey::HeyBuddyThinkingEffort).unwrap();
        assert_eq!(key, r#""heybuddyThinkingEffort""#);

        let parsed: PreferenceKey = serde_json::from_str(&key).unwrap();
        assert_eq!(parsed, PreferenceKey::HeyBuddyThinkingEffort);
    }
}
