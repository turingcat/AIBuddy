...
pub const REQUEST_RECIPE_PARAMS_METHOD: &str = "_aibuddy/unstable/session/recipe/request-params";
...
pub struct RecipeSettingsDto {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub aibuddy_provider: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub aibuddy_model: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
/// Encode a recipe as a aibuddy deep link.
...
/// Decode a aibuddy deep link into a recipe.
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_aibuddy/unstable/recipes/scan", response = ScanRecipeResponse)]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_aibuddy/unstable/recipes/save", response = SaveRecipeResponse)]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_aibuddy/unstable/recipes/parse", response = ParseRecipeResponse)]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_aibuddy/unstable/recipes/delete", response = EmptyResponse)]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_aibuddy/unstable/recipes/list", response = ListRecipesResponse)]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_aibuddy/unstable/recipes/schedule", response = EmptyResponse)]
