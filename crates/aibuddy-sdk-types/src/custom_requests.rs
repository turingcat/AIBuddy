...
#[request(method = "_aibuddy/unstable/session/extensions/add", response = EmptyResponse)]
#[serde(rename_all = "camelCase")]
pub struct AddSessionExtensionRequest {
    pub session_id: String,
    pub extension: AIBuddyExtension,
}

/// Remove an extension from an active session.
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_aibuddy/unstable/session/extensions/remove", response = EmptyResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_aibuddy/unstable/tools/list", response = GetToolsResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_aibuddy/unstable/resources/read", response = ReadResourceResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_aibuddy/unstable/tools/call", response = AIBuddyToolCallResponse)]
#[serde(rename_all = "camelCase")]
pub struct AIBuddyToolCallRequest {
    pub session_id: String,
    pub name: String,
    #[serde(default)]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcResponse)]
#[serde(rename_all = "camelCase")]
pub struct AIBuddyToolCallResponse {
    #[serde(default)]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_aibuddy/unstable/session/working-dir/update", response = EmptyResponse)]
#[serde(rename_all = "camelCase")]
...
pub enum SessionSystemPromptMode {
    /// Replace AIBuddy's base system prompt with the provided text.
    Set,
    /// Append the provided text under AIBuddy's "Additional Instructions" section.
    #[default]
    Append,
}
...
pub struct SteerSessionResponse {
    ...
    /// `messageId` on the streamed `UserMessageChunk` (with `_meta.aibuddy.steer`),
...
impl Default for AIBuddyExtension {
    fn default() -> Self {
        Self::Builtin {
            name: String::new(),
            description: None,
...
#[derive(Debug, Clone, Serialize, Deserialize, JsonSchema)]
#[serde(rename_all = "camelCase")]
pub struct AIBuddyExtensionEntry {
    pub extension: AIBuddyExtension,
    pub enabled: bool,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct GetConfigExtensionsResponse {
    pub extensions: Vec<AIBuddyExtensionEntry>,
    #[serde(default)]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_aibuddy/unstable/config/extensions/add", response = EmptyResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_aibuddy/unstable/config/extensions/remove", response = EmptyResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_aibuddy/unstable/preferences/read", response = PreferencesReadResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_aibuddy/unstable/preferences/save", response = EmptyResponse)]
#[serde(rename_all = "camelCase")]
...
pub enum PreferenceKey {
    ...
    #[serde(rename = "aibuddyThinkingEffort")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_aibuddy/unstable/session/project/update", response = EmptyResponse)]
#[serde(rename_all = "camelCase")]
...
/// Rename a session.
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_aibuddy/unstable/session/rename", response = EmptyResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_aibuddy/unstable/session/archive", response = EmptyResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_aibuddy/unstable/session/unarchive", response = EmptyResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_aibuddy/unstable/session/export", response = ExportSessionResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_aibuddy/unstable/session/import", response = ImportSessionResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_aibuddy/unstable/sources/create", response = CreateSourceResponse)]
#[serde(rename_all = "camelCase")]
...
/// skills.
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_aibuddy/unstable/sources/list", response = ListSourcesResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_aibuddy/unstable/sources/update", response = UpdateSourceResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_aibuddy/unstable/sources/delete", response = EmptyResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_aibuddy/unstable/sources/export", response = ExportSourceResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_aibuddy/unstable/sources/import", response = ImportSourcesResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_aibuddy/unstable/dictation/transcribe", response = DictationTranscribeResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_aibuddy/unstable/dictation/config", response = DictationConfigResponse)]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_aibuddy/unstable/providers/list", response = ListProvidersResponse)]
#[serde(rename_all = "camelCase")]
...
pub struct ProviderInventoryEntryDto {
    ...
    /// Whether AIBuddy has enough configuration to use this provider.
    pub configured: bool,
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_aibuddy/unstable/dictation/models/download", response = EmptyResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_aibuddy/unstable/dictation/models/cancel", response = EmptyResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_aibuddy/unstable/dictation/models/delete", response = EmptyResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_aibuddy/unstable/tools/permissions/set", response = SetToolPermissionsResponse)]
#[serde(rename_all = "camelCase")]
...
mod tests {
    ...
    #[test]
    fn preference_key_preserves_aibuddy_wire_casing() {
        let key = serde_json::to_string(&PreferenceKey::AIBuddyThinkingEffort).unwrap();
        assert_eq!(key, r#""aibuddyThinkingEffort""#);

        let parsed: PreferenceKey = serde_json::from_str(&key).unwrap();
        assert_eq!(parsed, PreferenceKey::AIBuddyThinkingEffort);
    }
}
