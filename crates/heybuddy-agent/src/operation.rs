...
use heybuddy_provider_types::conversation::message::{Message, MessageContent, MessageErrorKind};
use heybuddy_provider_types::conversation::{effective_role, Conversation, EffectiveRole};
use rmcp::model::Tool;
