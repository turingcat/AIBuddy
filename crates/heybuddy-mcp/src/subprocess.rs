...
///
/// Ported from `crates/heybuddy/src/agents/platform_extensions/developer/shell.rs`
/// where it was introduced in #5774 for the developer extension. This makes the
/// same fix available to all MCP extensions in heybuddy-mcp.
#[cfg(not(windows))]
fn resolve_login_shell_path() -> Option<String> {
    ...
    // cannot steal the terminal foreground from the parent heybuddy process.
