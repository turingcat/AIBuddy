...
pub const TOOL_META_EXTERNAL_DISPATCH_KEY: &str = "heybuddy.external_dispatch";
...
pub const TOOL_META_TITLE_KEY: &str = "heybuddy.toolSummary.title";
...
pub const TOOL_META_PROVIDER_INDEX_KEY: &str = "heybuddy.toolCall.providerIndex";
...
pub const TOOL_META_CHAIN_SUMMARY_KEY: &str = "heybuddy.toolChain.summary";
...
pub struct MessageMetadata {
    ...
    /// surfaced as `_meta.heybuddy.steer` so clients can mark the steer boundary
...
mod tests {
    ...
    fn test_elicitation_response_defaults_action_to_accept() {
        ...
        assert_eq!(user_data, serde_json::json!({ "name": "heybuddy" }));
