...
pub fn get_setup_catalog_entries(
    ...
    let heybuddy = ProviderSetupCatalogEntry {
        provider_id: "heybuddy".to_string(),
        ...
        fields: Vec::new(),
        aliases: vec!["heybuddy".to_string()],
        native_connect_query: None,
        binary_name: None,
        setup_capabilities: ProviderSetupCapabilities {
            install: false,
