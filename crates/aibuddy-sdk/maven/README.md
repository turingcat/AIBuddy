...
This project packages the UniFFI-generated Kotlin/JVM bindings for `aibuddy-sdk`
as the Maven artifact `io.github.aaif-aibuddy:gdk`.

The artifact version is read from `crates/aibuddy-sdk/Cargo.toml`, so it stays in
...
```bash
just --justfile crates/aibuddy-sdk/justfile maven-publish
```
