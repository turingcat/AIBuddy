...
use aibuddy::subprocess::{configure_subprocess, spawn_long_lived_mcp_subprocess};
...
const HELPER_ENV: &str = "AIBUDDY_SUBPROCESS_PARENT_DEATH_HELPER";
const THREAD_HELPER_ENV: &str = "AIBUDDY_SUBPROCESS_THREAD_DEATH_HELPER";
