...
use aibuddy::session::session_manager::SessionStorage;
...
fn mock_provider_factory() -> aibuddy::acp::server::AcpProviderFactory {
    Arc::new(
...
fn provider_secret_mutations_and_inventory_refresh_invalidate_global_secret_cache() {
    ...
    let _env = env_lock::lock_env([
        ("AIBUDDY_PATH_ROOT", Some(root_path.as_str())),
