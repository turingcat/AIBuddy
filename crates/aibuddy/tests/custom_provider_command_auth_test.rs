...
use aibuddy::providers::openai_def;
use aibuddy_providers::declarative::{AuthConfig, DeclarativeProviderConfig, ProviderEngine};
...
fn custom_config_with_auth(base_url: &str, auth: AuthConfig) -> DeclarativeProviderConfig {
    DeclarativeProviderConfig {
        ...
        models: vec![aibuddy_providers::base::ModelInfo::new("test-model")],
        headers: None,
