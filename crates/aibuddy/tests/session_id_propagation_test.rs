...
use aibuddy::providers::api_client::{ApiClient, AuthMethod};
use aibuddy::providers::base::Provider;
use aibuddy::providers::openai::OpenAiProvider;
use aibuddy::session_context::{session_id_request_builder, SESSION_ID_HEADER};
...
async fn make_request(provider: &dyn Provider, session_id: &str) {
    ...
    let _ = aibuddy::session_context::with_session_id(
