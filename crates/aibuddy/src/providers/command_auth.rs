use aibuddy_providers::declarative::AuthConfig;
use anyhow::Result;
...
pub struct CommandAuthProvider {
    ...
    /// resolves against. Captured once at construction (defaults to aibuddy's
...
impl CommandAuthProvider {
    ...
    async fn fetch_token(&self) -> Result<String> {
        ...
        // shell-interpolated. Inherits aibuddy's full environment, since the
        // same user configures aibuddy and writes the script.
