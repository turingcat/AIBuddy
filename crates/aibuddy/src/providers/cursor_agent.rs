...
impl CursorAgentProvider {
    ...
    /// Convert aibuddy messages to a simple prompt format for cursor-agent CLI
    ...
    async fn execute_command(
        ...
        if std::env::var("AIBUDDY_CURSOR_AGENT_DEBUG").is_ok() {
...
impl aibuddy_providers::base::ProviderDescriptor for CursorAgentProvider {
