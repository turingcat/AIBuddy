...
impl aibuddy_providers::base::ProviderDescriptor for ClaudeAcpProvider {
    fn metadata() -> ProviderMetadata {
        ProviderMetadata::new(
            CLAUDE_ACP_PROVIDER_NAME,
            "Claude Code ACP",
            "Use aibuddy with your Claude Code subscription via the claude-agent-acp adapter.",
            ACP_CURRENT_MODEL,
            vec![],
            CLAUDE_ACP_DOC_URL,
            vec![],
    ...
    fn from_env_with_working_dir(
        ...
        Box::pin(async move {
            ...
            let provider_config = AcpProviderConfig {
                ...
                session_mode_id: mode_mapping[&aibuddy_mode].first().cloned(),
