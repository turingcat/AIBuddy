...
impl aibuddy_providers::base::ProviderDescriptor for AmpAcpProvider {
    fn metadata() -> ProviderMetadata {
        ProviderMetadata::new(
            AMP_ACP_PROVIDER_NAME,
            "Amp",
            "Use aibuddy with your Amp subscription via the amp-acp adapter.",
            ACP_CURRENT_MODEL,
            vec![],
            AMP_ACP_DOC_URL,
            vec![],
    ...
    fn from_env_with_working_dir(
        ...
        Box::pin(async move {
            ...
            let mode_mapping = HashMap::from([
                ...
                (AIBuddyMode::Auto, vec!["bypass".to_string()]),
                // "default" prompts before risky actions.
                (AIBuddyMode::Approve, vec!["default".to_string()]),
                (AIBuddyMode::SmartApprove, vec!["default".to_string()]),
                (AIBuddyMode::Chat, vec!["default".to_string()]),
            ]);
