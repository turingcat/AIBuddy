...
use aibuddy_providers::api_client::{AuthMethod, AuthProvider, TlsConfig};
use aibuddy_providers::azure_foundry::{endpoint_kind, AzureFoundryProvider, EndpointKind};
use aibuddy_providers::base::{ProviderDescriptor, ProviderMetadata};
use anyhow::Result;
