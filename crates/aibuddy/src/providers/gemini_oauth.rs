...
static HTTP_CLIENT: LazyLock<reqwest::Client> = LazyLock::new(|| {
    aibuddy_providers::provider_reqwest_builder()
        .build()
...
<html>
  <head>
    <title>aibuddy - Google Authorization Successful</title>
    <style>
      body {
...
<html>
  <head>
    <title>aibuddy - Google Authorization Failed</title>
    <style>
      body {{
        font-family: system-ui, -apple-system, sans-serif;
        display: flex;
...
impl GeminiOAuthProvider {
    ...
    async fn post_stream(
        ...
        if !response.status().is_success() {
            ...
            let text = aibuddy_providers::http_status::read_error_body(response)
                .await
...
impl aibuddy_providers::base::ProviderDescriptor for GeminiOAuthProvider {
