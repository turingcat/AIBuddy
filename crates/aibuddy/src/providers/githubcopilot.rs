...
use aibuddy_providers::formats::openai::is_openai_responses_model;
...
use aibuddy_providers::formats::openai::{create_request, get_usage, response_to_message};
...
impl aibuddy_providers::base::ProviderDescriptor for GithubCopilotProvider {
    fn metadata() -> ProviderMetadata {
        ProviderMetadata::new(
            GITHUB_COPILOT_PROVIDER_NAME,
            "GitHub Copilot",
            "GitHub Copilot. Run `aibuddy configure` and select copilot to set up.",
