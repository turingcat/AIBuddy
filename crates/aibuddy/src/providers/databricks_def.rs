use aibuddy_providers::api_client::TlsConfig;
use aibuddy_providers::base::ProviderDescriptor;
use aibuddy_providers::databricks::DatabricksProvider;
use aibuddy_providers::databricks_auth::{
...
fn resolve_instance_id() -> Option<String> {
    let enabled = Config::global()
        .get_param::<bool>("AIBUDDY_DATABRICKS_CLIENT_REQUEST_ID")
        .unwrap_or(false);
