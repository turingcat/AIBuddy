use aibuddy_providers::cache_semantics::apply_chat_payload_breakpoints;
...
impl aibuddy_providers::base::ProviderDescriptor for LiteLLMProvider {
...
impl Provider for LiteLLMProvider {
    ...
    async fn stream(
        ...
        let mut payload = aibuddy_providers::formats::openai::create_request(
            model_config,
            system,
            messages,
            tools,
        ...
        let message = aibuddy_providers::formats::openai::response_to_message(&response)?;
        let usage = aibuddy_providers::formats::openai::get_usage(&response);
