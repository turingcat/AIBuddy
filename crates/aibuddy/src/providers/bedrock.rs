...
use aibuddy_providers::formats::openai::extract_reasoning_effort;
use aibuddy_providers::formats::openai_responses::create_responses_request;
...
impl BedrockProvider {
    pub async fn from_env(
        ...
        // AWS SDK 的 UA 无法替换，只能经 app_name 追加产品标识（形如 "... app/AIBuddy-1.0.6"）
        // @author: logic
        // @date: 2026-09-03
        let mut loader = aws_config::defaults(aws_config::BehaviorVersion::latest())
            .http_client(ReqwestHttpClient::new())
            .app_name(
                aws_config::AppName::new(aibuddy_providers::PRODUCT_AWS_APP_NAME)
        ...
        Ok(Self {
            ...
            bearer_token,
            http_client: aibuddy_providers::provider_reqwest_builder().build()?,
    ...
    async fn post_mantle_streaming(
        ...
        let response = aibuddy_providers::http_status::send_bounded(
            req,
...
impl aibuddy_providers::base::ProviderDescriptor for BedrockProvider {
...
impl Provider for BedrockProvider {
    ...
    async fn get_context_limit(&self, model: &str, override_limit: Option<usize>) -> usize {
        ...
        aibuddy_providers::context_limit::ContextLimitResolver::new(&self.name)
...
mod tests {
    ...
    fn create_mock_provider_and_model(model_name: &str) -> (BedrockProvider, ModelConfig) {
        ...
        (
            BedrockProvider {
                ...
                region: None,
                bearer_token: None,
                http_client: aibuddy_providers::provider_reqwest_builder()
                    .build()
                    .unwrap(),
                mantle_base_url: None,
            },
    ...
    async fn test_mantle_stream_returns_text_message() {
        ...
        Mock::given(method("POST"))
            ...
            .and(header("user-agent", aibuddy_providers::PRODUCT_USER_AGENT))
