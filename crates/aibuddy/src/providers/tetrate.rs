...
impl aibuddy_providers::base::ProviderDescriptor for TetrateProvider {
    ...
    async fn stream(
        ...
        let response = self
            .with_retry(|| async {
                ...
                if is_json {
                    let body = aibuddy_providers::http_status::read_error_body(resp)
                        .await
                        .unwrap_or_default();
