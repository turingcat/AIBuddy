...
pub fn session_id_request_builder() -> aibuddy_providers::api_client::RequestBuilderDecorator {
...
/// Local OS user running aibuddy, shared by the OTLP `user.name` resource
...
/// Hostname of the machine running aibuddy, shared by the OTLP `host.name`
