...
pub struct LoggingConfig<'a> {
    ...
    /// Additional `EnvFilter` directives beyond the defaults (e.g. "aibuddy_cli=info").
...
fn build_env_filter(extra_directives: &[&str]) -> EnvFilter {
    ...
    let mut filter = EnvFilter::new("")
        ...
        .add_directive("aibuddy=info".parse().unwrap())
...
/// Set up file-based (and optionally console) tracing for a aibuddy component.
///
