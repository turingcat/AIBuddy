...
//! Usage: cargo run -p aibuddy --bin analyze_cli -- <path> [--focus <symbol>] [--depth <n>] [--follow <n>] [--force]

use aibuddy::agents::platform_extensions::analyze::{format, graph, AnalyzeClient};
use clap::Parser;
use rayon::prelude::*;
