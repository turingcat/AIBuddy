use aibuddy::acp::custom_notifications::custom_notification_schemas;
use aibuddy::acp::server::{agent_request_schemas, AIBuddyAcpAgent};
...
fn main() {
    ...
    let methods = AIBuddyAcpAgent::custom_method_schemas(&mut generator);
...
fn is_unstable_method(method: &str) -> bool {
    method.contains("_aibuddy/unstable")
}
