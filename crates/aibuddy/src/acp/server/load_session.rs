...
fn build_replayed_tool_call(
    ...
    let aibuddy_meta = tool_call
        .meta
        .get_or_insert_default()
        .entry("aibuddy".to_string())
        .or_insert_with(|| serde_json::Value::Object(serde_json::Map::new()));
    if !aibuddy_meta.is_object() {
        *aibuddy_meta = serde_json::Value::Object(serde_json::Map::new());
    }
    aibuddy_meta
        .as_object_mut()
        .expect("aibuddy metadata was initialized as an object")
...
mod tests {
    ...
    fn replay_includes_persisted_enrichment_when_requested() {
        ...
        let aibuddy = tool_call
            .meta
            .as_ref()
            .and_then(|meta| meta.get("aibuddy"))
            .expect("valid initial tool call should contain aibuddy metadata");
