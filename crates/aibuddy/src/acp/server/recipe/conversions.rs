use aibuddy_sdk_types::custom_requests::{
...
impl From<RecipeSettingsDto> for Settings {
    fn from(dto: RecipeSettingsDto) -> Self {
        Self {
            aibuddy_provider: dto.aibuddy_provider,
            aibuddy_model: dto.aibuddy_model,
...
impl From<Settings> for RecipeSettingsDto {
    fn from(settings: Settings) -> Self {
        Self {
            aibuddy_provider: settings.aibuddy_provider,
            aibuddy_model: settings.aibuddy_model,
...
) -> Result<aibuddy_sdk_types::custom_requests::RecipeListEntryDto> {
    Ok(aibuddy_sdk_types::custom_requests::RecipeListEntryDto {
        id,
    ...
    fn converts_recipe_dto_to_recipe_and_back() {
        let dto = RecipeDto {
            ...
            settings: Some(RecipeSettingsDto {
                ...
                aibuddy_model: Some("gpt-5".to_string()),
