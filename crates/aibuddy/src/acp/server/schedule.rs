...
use super::{build_session_info, AIBuddyAcpAgent, ResultExt};
...
mod tests {
    ...
    use aibuddy_sdk_types::custom_requests::{ListRecipesRequest, ScheduleRecipeRequest};
    ...
    async fn disabled_scheduler_rejects_schedule_operations_without_recipe_writes() {
        ...
        let _guard = env_lock::lock_env([
            ("AIBUDDY_DISABLE_KEYRING", Some("true")),
            ("AIBUDDY_PATH_ROOT", root.path().to_str()),
        ]);
