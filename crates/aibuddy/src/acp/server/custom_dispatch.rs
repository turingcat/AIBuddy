...
use aibuddy_acp_macros::custom_methods;

use super::*;

const LEGACY_CUSTOM_METHOD_PREFIX: &str = "_aibuddy/unstable/";
const CUSTOM_METHOD_PREFIX: &str = "_aibuddy/unstable/";
...
impl AIBuddyAcpAgent {
    ...
    #[custom_method(AIBuddyToolCallRequest)]
