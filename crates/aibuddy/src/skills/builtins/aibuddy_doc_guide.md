---
name: aibuddy-doc-guide
description: Reference aibuddy documentation to create, configure, or explain aibuddy-specific features like recipes, extensions, sessions, and providers. You MUST read the relevant aibuddy docs before answering. You MUST NOT rely on training data or assumptions for any aibuddy-specific fields, values, names, syntax, or commands.
---

Use this skill when working with **aibuddy-specific features**:
- Creating or editing recipes
- Configuring extensions or providers
- Explaining how aibuddy features work
- Any aibuddy configuration or setup task

Do NOT use this skill for:
- General coding tasks unrelated to aibuddy
- Running existing recipes (just run them directly)

The docs root for this session is `{{AIBUDDY_DOCS_ROOT}}`. It may be a local
...
1. **Read official docs**
   - Read the doc map from `<docs-root>/aibuddy-docs-map.md`
...
2. **Create/modify content**
   - For aibuddy configuration files:
      ...
      - **⚠️ STOP: Before showing the user, verify output content MUST match the schema and reference in the aibuddy official documentation:**
...
3. **MANDATORY VERIFICATION - CHECK ALL THESE ITEMS BEFORE STEP 4**
   ...
   - [ ] You MUST NOT rely on training data or assumptions for any aibuddy-specific fields, values, names, syntax, or commands.
   ...
   - [ ] List all aibuddy-specific items in your answer (commands, fields, syntax, values, how to use, explanations, etc.)
...
4. **Provide your answer and include a "Verification Completed" section**
   - For EACH aibuddy-specific item in your response, cite the specific doc file where you verified it
