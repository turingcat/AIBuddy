...
// These are used by integration tests in crates/aibuddy/tests/
    ...
    || {
        ...
        map.insert(
            ...
            PlatformExtensionDef {
                ...
                display_name: "Apps",
                description:
                    "Create and manage custom AIBuddy apps through chat. Apps are HTML/CSS/JavaScript and run in sandboxed windows.",
                default_enabled: true,
                unprefixed_tools: false,
                hidden: false,
        ...
        map.insert(
            ...
            PlatformExtensionDef {
                ...
                description:
                    "AIBuddy will make extension calls through code execution, saving tokens",
                default_enabled: false,
                unprefixed_tools: true,
                hidden: false,
                client_factory: |ctx| {
        ...
        map.insert(
            ...
            PlatformExtensionDef {
                ...
                description:
                    "Inject custom context into every turn via AIBUDDY_MOIM_MESSAGE_TEXT and AIBUDDY_MOIM_MESSAGE_FILE environment variables",
                default_enabled: true,
                unprefixed_tools: false,
                hidden: false,
...
impl PlatformExtensionContext {
    pub async fn model_config_for_session(
        &self,
        session_id: &str,
    ) -> Result<aibuddy_providers::model::ModelConfig, String> {
