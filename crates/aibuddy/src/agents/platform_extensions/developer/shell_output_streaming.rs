...
pub const DEVELOPER_SHELL_OUTPUT_NOTIFICATION_METHOD: &str = "aibuddy/developer_shell_output";
...
mod tests {
    ...
    fn parser_ignores_unrelated_or_malformed_custom_notifications() {
        let unrelated = CustomNotification::new("aibuddy/other", Some(serde_json::json!({})));
