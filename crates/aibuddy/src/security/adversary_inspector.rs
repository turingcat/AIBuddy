...
///
/// Activated by placing an `adversary.md` file in the AIBuddy config directory
/// (`~/.config/aibuddy/adversary.md`). The file contains optional frontmatter
...
mod tests {
    ...
    async fn test_disabled_when_no_adversary_md() {
        ...
        let results = inspector
            .inspect("test", &[request], &[], AIBuddyMode::Auto)
            .await
            .unwrap();
