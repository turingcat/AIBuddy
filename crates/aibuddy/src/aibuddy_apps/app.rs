...
impl AIBuddyApp {
    ...
    const PRD_SCRIPT_TYPE: &'static str = "application/x-aibuddy-prd";
    const AIBUDDY_APP_TYPE: &'static str = "AIBuddyApp";
    const AIBUDDY_SCHEMA_CONTEXT: &'static str = "urn:aibuddy.ai:schema";
    ...
    pub fn from_html(html: &str) -> Result<Self, String> {
        ...
        let json_str = metadata_re
            ...
            .ok_or_else(|| "No AIBuddyApp JSON-LD metadata found in HTML".to_string())?
            .as_str();
    ...
    pub fn to_html(&self) -> Result<String, String> {
        ...
        let mut metadata = serde_json::json!({
            "@context": Self::AIBUDDY_SCHEMA_CONTEXT,
            "@type": Self::AIBUDDY_APP_TYPE,
...
pub async fn fetch_mcp_apps(
    ...
    session_id: &str,
) -> Result<Vec<AIBuddyApp>, ErrorData> {
