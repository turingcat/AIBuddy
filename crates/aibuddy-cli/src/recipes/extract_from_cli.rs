...
use aibuddy::recipe::{Recipe, SubRecipe};
...
mod tests {
    ...
    fn test_extract_recipe_info_from_cli_basic() {
        ...
        assert_eq!(settings.aibuddy_provider, Some("test_provider".to_string()));
        assert_eq!(settings.aibuddy_model, Some("test_model".to_string()));
...
settings:
  aibuddy_provider: test_provider
