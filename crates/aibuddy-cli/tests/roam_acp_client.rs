...
//! stands in for aibuddy's real `serve` and implements the session surface the
...
use aibuddy_cli::commands::roam_client;
use aibuddy_roaming::{
...
async fn connect_to_stub() -> (Arc<RoamingNode>, aibuddy_roaming::RoamingClientStream) {
