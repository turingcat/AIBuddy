...
//! over the `heybuddy-acp/1` ALPN, and dials remote agents as a client.
...
/// ALPN identifying the heybuddy ACP-over-iroh protocol.
pub const ROAMING_ACP_ALPN: &[u8] = b"heybuddy-acp/1";
...
/// integration layer (e.g. `heybuddy-cli`) so this crate does not depend on the
...
///
/// ```no_run
/// use heybuddy_roaming::{RoamingConfig, RoamingIdentity, RoamingNode};
