...
impl CursorAgentProvider {
    ...
    /// Convert heybuddy messages to a simple prompt format for cursor-agent CLI
    ...
    async fn execute_command(
        ...
        if std::env::var("HEYBUDDY_CURSOR_AGENT_DEBUG").is_ok() {
...
impl heybuddy_providers::base::ProviderDescriptor for CursorAgentProvider {
