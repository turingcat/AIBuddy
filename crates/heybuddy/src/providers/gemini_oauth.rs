...
static HTTP_CLIENT: LazyLock<reqwest::Client> = LazyLock::new(|| {
    heybuddy_providers::provider_reqwest_builder()
        .build()
...
<html>
  <head>
    <title>heybuddy - Google Authorization Successful</title>
    <style>
      body {
...
<html>
  <head>
    <title>heybuddy - Google Authorization Failed</title>
    <style>
      body {{
        font-family: system-ui, -apple-system, sans-serif;
        display: flex;
...
impl GeminiOAuthProvider {
    ...
    async fn post_stream(
        ...
        if !response.status().is_success() {
            ...
            let text = heybuddy_providers::http_status::read_error_body(response)
                .await
...
impl heybuddy_providers::base::ProviderDescriptor for GeminiOAuthProvider {
