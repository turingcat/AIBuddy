...
use heybuddy_providers::formats::openai::is_openai_responses_model;
...
use heybuddy_providers::formats::openai::{create_request, get_usage, response_to_message};
...
impl heybuddy_providers::base::ProviderDescriptor for GithubCopilotProvider {
    fn metadata() -> ProviderMetadata {
        ProviderMetadata::new(
            GITHUB_COPILOT_PROVIDER_NAME,
            "GitHub Copilot",
            "GitHub Copilot. Run `heybuddy configure` and select copilot to set up.",
