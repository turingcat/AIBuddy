...
use heybuddy_providers::api_client::TlsConfig;
use heybuddy_providers::base::ProviderDescriptor;
use heybuddy_providers::databricks::DatabricksProvider;
use heybuddy_providers::databricks_auth::{
...
fn resolve_instance_id() -> Option<String> {
    let enabled = Config::global()
        .get_param::<bool>("HEYBUDDY_DATABRICKS_CLIENT_REQUEST_ID")
        .unwrap_or(false);
