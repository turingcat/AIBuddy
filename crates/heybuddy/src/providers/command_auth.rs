...
use heybuddy_providers::declarative::AuthConfig;
...
pub struct CommandAuthProvider {
    ...
    /// resolves against. Captured once at construction (defaults to heybuddy's
...
impl CommandAuthProvider {
    ...
    async fn fetch_token(&self) -> Result<String> {
        ...
        // shell-interpolated. Inherits heybuddy's full environment, since the
        // same user configures heybuddy and writes the script.
