...
use heybuddy_providers::cache_semantics::apply_chat_payload_breakpoints;
...
impl heybuddy_providers::base::ProviderDescriptor for LiteLLMProvider {
...
impl Provider for LiteLLMProvider {
    ...
    async fn stream(
        ...
        let mut payload = heybuddy_providers::formats::openai::create_request(
            model_config,
            system,
            messages,
            tools,
        ...
        let message = heybuddy_providers::formats::openai::response_to_message(&response)?;
        let usage = heybuddy_providers::formats::openai::get_usage(&response);
