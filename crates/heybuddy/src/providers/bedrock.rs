...
use heybuddy_providers::formats::openai::extract_reasoning_effort;
use heybuddy_providers::formats::openai_responses::create_responses_request;
...
impl BedrockProvider {
    pub async fn from_env(
        ...
        let mut loader = aws_config::defaults(aws_config::BehaviorVersion::latest())
            ...
            .app_name(
                aws_config::AppName::new(heybuddy_providers::PRODUCT_AWS_APP_NAME)
        ...
        Ok(Self {
            ...
            bearer_token,
            http_client: heybuddy_providers::provider_reqwest_builder().build()?,
    ...
    async fn post_mantle_streaming(
        ...
        let response = heybuddy_providers::http_status::send_bounded(
            req,
...
impl heybuddy_providers::base::ProviderDescriptor for BedrockProvider {
...
impl Provider for BedrockProvider {
    ...
    async fn get_context_limit(&self, model: &str, override_limit: Option<usize>) -> usize {
        ...
        heybuddy_providers::context_limit::ContextLimitResolver::new(&self.name)
...
mod tests {
    ...
    fn create_mock_provider_and_model(model_name: &str) -> (BedrockProvider, ModelConfig) {
        ...
        (
            BedrockProvider {
                ...
                region: None,
                bearer_token: None,
                http_client: heybuddy_providers::provider_reqwest_builder()
                    .build()
                    .unwrap(),
                mantle_base_url: None,
            },
    ...
    async fn test_mantle_stream_returns_text_message() {
        ...
        Mock::given(method("POST"))
            ...
            .and(header("user-agent", heybuddy_providers::PRODUCT_USER_AGENT))
