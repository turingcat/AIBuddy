use heybuddy::acp::custom_notifications::custom_notification_schemas;
use heybuddy::acp::server::{agent_request_schemas, HeyBuddyAcpAgent};
...
fn main() {
    ...
    let methods = HeyBuddyAcpAgent::custom_method_schemas(&mut generator);
...
fn is_unstable_method(method: &str) -> bool {
    method.contains("_heybuddy/unstable")
}
