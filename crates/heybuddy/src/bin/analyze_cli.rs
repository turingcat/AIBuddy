...
//! Usage: cargo run -p heybuddy --bin analyze_cli -- <path> [--focus <symbol>] [--depth <n>] [--follow <n>] [--force]

use clap::Parser;
use heybuddy::agents::platform_extensions::analyze::{format, graph, AnalyzeClient};
use rayon::prelude::*;
