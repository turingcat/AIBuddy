...
use crate::config::{resolve_extensions_for_new_session, Config, HeyBuddyMode};
...
async fn execute_job(
    ...
    agent
        ...
        .await?;
    agent
        .update_heybuddy_mode(HeyBuddyMode::Auto, &session.id)
        .await?;
...
mod tests {
    ...
    async fn test_job_runs_on_schedule() {
        ...
        assert_eq!(sessions[0].heybuddy_mode, HeyBuddyMode::Auto);
    }
