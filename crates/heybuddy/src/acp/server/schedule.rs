...
use super::{build_session_info, HeyBuddyAcpAgent, ResultExt};
...
mod tests {
    ...
    use heybuddy_sdk_types::custom_requests::{ListRecipesRequest, ScheduleRecipeRequest};
    ...
    async fn disabled_scheduler_rejects_schedule_operations_without_recipe_writes() {
        ...
        let _guard = env_lock::lock_env([
            ("HEYBUDDY_DISABLE_KEYRING", Some("true")),
            ("HEYBUDDY_PATH_ROOT", root.path().to_str()),
        ]);
