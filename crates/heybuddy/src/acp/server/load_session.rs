...
fn build_replayed_tool_call(
    ...
    let heybuddy_meta = tool_call
        .meta
        .get_or_insert_default()
        .entry("heybuddy".to_string())
        .or_insert_with(|| serde_json::Value::Object(serde_json::Map::new()));
    if !heybuddy_meta.is_object() {
        *heybuddy_meta = serde_json::Value::Object(serde_json::Map::new());
    }
    heybuddy_meta
        .as_object_mut()
        .expect("heybuddy metadata was initialized as an object")
...
mod tests {
    ...
    fn replay_includes_persisted_enrichment_when_requested() {
        ...
        let heybuddy = tool_call
            .meta
            .as_ref()
            .and_then(|meta| meta.get("heybuddy"))
            .expect("valid initial tool call should contain heybuddy metadata");
