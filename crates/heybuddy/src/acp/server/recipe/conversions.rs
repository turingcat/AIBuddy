use anyhow::Result;
use heybuddy_sdk_types::custom_requests::{
...
impl From<RecipeSettingsDto> for Settings {
    fn from(dto: RecipeSettingsDto) -> Self {
        Self {
            heybuddy_provider: dto.heybuddy_provider,
            heybuddy_model: dto.heybuddy_model,
...
impl From<Settings> for RecipeSettingsDto {
    fn from(settings: Settings) -> Self {
        Self {
            heybuddy_provider: settings.heybuddy_provider,
            heybuddy_model: settings.heybuddy_model,
...
) -> Result<heybuddy_sdk_types::custom_requests::RecipeListEntryDto> {
    Ok(heybuddy_sdk_types::custom_requests::RecipeListEntryDto {
        id,
    ...
    fn converts_recipe_dto_to_recipe_and_back() {
        let dto = RecipeDto {
            ...
            settings: Some(RecipeSettingsDto {
                ...
                heybuddy_model: Some("gpt-5".to_string()),
