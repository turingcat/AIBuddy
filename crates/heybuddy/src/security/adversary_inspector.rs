...
///
/// Activated by placing an `adversary.md` file in the HeyBuddy config directory
/// (`~/.config/heybuddy/adversary.md`). The file contains optional frontmatter
...
mod tests {
    ...
    async fn test_disabled_when_no_adversary_md() {
        ...
        let results = inspector
            .inspect("test", &[request], &[], HeyBuddyMode::Auto)
            .await
            .unwrap();
