...
use crate::agents::state_machine::{
    ...
    ExitOnErrorOperation, HeyBuddyEffect, HeyBuddyInferenceProvider,
    HeyBuddyInferenceRequestPreparer, InferenceRunner, MaxTurnsOperation, Operation,
...
impl Provider for FeatureProvider {
    ...
    ) -> Result<crate::providers::base::MessageStream, heybuddy_providers::errors::ProviderError>
    {
        self.inner
    ...
    async fn fetch_model_info(
        &self,
        model_name: &str,
    ) -> Result<heybuddy_providers::base::ModelInfo, heybuddy_providers::errors::ProviderError>
    {
...
pub(super) struct TestPipeline {
    ...
    heybuddy_mode: TokioMutex<HeyBuddyMode>,
...
impl TestPipeline {
    pub(super) fn machine(
        ...
        let request_preparer = HeyBuddyInferenceRequestPreparer {
            ...
            heybuddy_mode: &self.heybuddy_mode,
    ...
    pub(super) async fn with_heybuddy_mode(self, mode: HeyBuddyMode) -> Self {
        *self.heybuddy_mode.lock().await = mode;
...
async fn test_pipeline_with_components(
    ...
    let session = session_manager
        ...
        .await?;
    let model_config = ModelConfig::new(heybuddy_providers::openai::OPEN_AI_DEFAULT_MODEL)
...
async fn build_test_pipeline(
    ...
    let api_client = heybuddy_providers::api_client::ApiClient::new_with_tls(
        api.uri(),
        heybuddy_providers::api_client::AuthMethod::NoAuth,
        None,
    )?;
    let provider: Arc<dyn Provider> = Arc::new(
        heybuddy_providers::openai::OpenAiProviderBuilder::new(api_client)
            .name(provider_name)
    ...
    let pipeline = TestPipeline {
        ...
        model_config,
        extension_manager,
        heybuddy_mode: TokioMutex::new(session.heybuddy_mode),
