...
pub const DEVELOPER_SHELL_OUTPUT_NOTIFICATION_METHOD: &str = "heybuddy/developer_shell_output";
...
mod tests {
    ...
    fn parser_ignores_unrelated_or_malformed_custom_notifications() {
        let unrelated = CustomNotification::new("heybuddy/other", Some(serde_json::json!({})));
