...
/// HeyBuddy-specific credential store that uses the Config system
///
/// This implementation stores OAuth credentials in the heybuddy configuration
/// system, which handles secure storage (e.g., keychain integration).

#[derive(Clone)]
pub struct HeyBuddyCredentialStore {
    name: String,
}

impl HeyBuddyCredentialStore {
...
impl CredentialStore for HeyBuddyCredentialStore {
