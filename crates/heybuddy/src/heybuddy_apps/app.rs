...
impl HeyBuddyApp {
    ...
    const PRD_SCRIPT_TYPE: &'static str = "application/x-heybuddy-prd";
    const HEYBUDDY_APP_TYPE: &'static str = "HeyBuddyApp";
    const HEYBUDDY_SCHEMA_CONTEXT: &'static str = "urn:heybuddy.ai:schema";
    ...
    pub fn from_html(html: &str) -> Result<Self, String> {
        ...
        let json_str = metadata_re
            ...
            .ok_or_else(|| "No HeyBuddyApp JSON-LD metadata found in HTML".to_string())?
            .as_str();
    ...
    pub fn to_html(&self) -> Result<String, String> {
        ...
        let mut metadata = serde_json::json!({
            "@context": Self::HEYBUDDY_SCHEMA_CONTEXT,
            "@type": Self::HEYBUDDY_APP_TYPE,
...
pub async fn fetch_mcp_apps(
    ...
    session_id: &str,
) -> Result<Vec<HeyBuddyApp>, ErrorData> {
