...
pub fn session_id_request_builder() -> heybuddy_providers::api_client::RequestBuilderDecorator {
...
/// Local OS user running heybuddy, shared by the OTLP `user.name` resource
...
/// Hostname of the machine running heybuddy, shared by the OTLP `host.name`
