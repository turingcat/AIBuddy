...
//!   cargo test -p heybuddy --test local_inference_perf -- --ignored --nocapture
//!
//! Run with a specific model:
//!   TEST_MODEL="bartowski/Qwen_Qwen3-32B-GGUF:Q4_K_M" cargo test -p heybuddy --test local_inference_perf -- --ignored --nocapture
