...
use heybuddy::providers::api_client::{ApiClient, AuthMethod};
use heybuddy::providers::base::Provider;
use heybuddy::providers::openai::OpenAiProvider;
use heybuddy::session_context::{session_id_request_builder, SESSION_ID_HEADER};
...
async fn make_request(provider: &dyn Provider, session_id: &str) {
    ...
    let _ = heybuddy::session_context::with_session_id(
