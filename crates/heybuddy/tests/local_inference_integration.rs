...
//!   heybuddy local-models download bartowski/Llama-3.2-1B-Instruct-GGUF:Q4_K_M
//!
//! Run with the default model:
//!   cargo test -p heybuddy --test local_inference_integration -- --ignored
//!
//! Run with a specific model:
//!   TEST_MODEL="bartowski/Qwen_Qwen3-32B-GGUF:Q4_K_M" cargo test -p heybuddy --test local_inference_integration -- --ignored
//!
//! Run vision tests (requires a vision-capable model like gemma-4):
//!   TEST_VISION_MODEL="unsloth/gemma-4-E4B-it-GGUF:Q4_K_M" cargo test -p heybuddy --test local_inference_integration test_local_inference_vision -- --ignored
...
async fn test_local_inference_large_prompt() {
    ...
    let padding = "You are HeyBuddy, a highly capable AI assistant.\n".repeat(80);
...
///     cargo test -p heybuddy --test local_inference_integration test_local_inference_vision -- --ignored
#[tokio::test]
#[ignore]
