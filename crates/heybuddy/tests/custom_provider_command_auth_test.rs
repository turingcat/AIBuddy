...
use heybuddy::providers::openai_def;
use heybuddy_providers::declarative::{AuthConfig, DeclarativeProviderConfig, ProviderEngine};
...
fn custom_config_with_auth(base_url: &str, auth: AuthConfig) -> DeclarativeProviderConfig {
    DeclarativeProviderConfig {
        ...
        models: vec![heybuddy_providers::base::ModelInfo::new("test-model")],
        headers: None,
