...
This project packages the UniFFI-generated Kotlin/JVM bindings for `heybuddy-sdk`
as the Maven artifact `io.github.aaif-heybuddy:gdk`.

The artifact version is read from `crates/heybuddy-sdk/Cargo.toml`, so it stays in
...
`darwin-aarch64`, `linux-x86-64`, `linux-aarch64`, and
...
```bash
just --justfile crates/heybuddy-sdk/justfile maven-publish
```
