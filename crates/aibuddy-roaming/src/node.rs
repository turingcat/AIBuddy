...
//! over the `aibuddy-acp/1` ALPN, and dials remote agents as a client.
...
/// ALPN identifying the aibuddy ACP-over-iroh protocol.
pub const ROAMING_ACP_ALPN: &[u8] = b"aibuddy-acp/1";
...
/// integration layer (e.g. `aibuddy-cli`) so this crate does not depend on the
...
///
/// ```no_run
/// use aibuddy_roaming::{RoamingConfig, RoamingIdentity, RoamingNode};
