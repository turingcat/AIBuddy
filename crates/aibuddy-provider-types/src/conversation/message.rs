...
pub const TOOL_META_EXTERNAL_DISPATCH_KEY: &str = "aibuddy.external_dispatch";
...
pub const TOOL_META_TITLE_KEY: &str = "aibuddy.toolSummary.title";
...
pub const TOOL_META_PROVIDER_INDEX_KEY: &str = "aibuddy.toolCall.providerIndex";
...
pub const TOOL_META_CHAIN_SUMMARY_KEY: &str = "aibuddy.toolChain.summary";
...
pub struct MessageMetadata {
    ...
    /// surfaced as `_meta.aibuddy.steer` so clients can mark the steer boundary
...
mod tests {
    ...
    fn test_elicitation_response_defaults_action_to_accept() {
        ...
        assert_eq!(user_data, serde_json::json!({ "name": "aibuddy" }));
