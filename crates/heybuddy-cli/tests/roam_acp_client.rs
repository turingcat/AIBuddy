...
//! stands in for heybuddy's real `serve` and implements the session surface the
...
use heybuddy_cli::commands::roam_client;
...
async fn connect_to_stub() -> (Arc<RoamingNode>, heybuddy_roaming::RoamingClientStream) {
