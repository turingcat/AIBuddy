...
echo "Using aibuddy release $acp_ref for ACP documentation."
...
git show "$acp_ref:crates/aibuddy/acp-schema.json" > "$schema"
git show "$acp_ref:crates/aibuddy/acp-meta.json" > "$meta"
