...
export default function CLIExtensionInstructions({
  ...
  return (
    <div>
      ...
      <CodeBlock language="sh">{`aibuddy configure`}</CodeBlock>
      ...
      <CodeBlock language="sh">{`┌   aibuddy-configure
│
...
└`}</CodeBlock>
      ...
      <ol start={5}>
        <li>
          Enter the number of seconds aibuddy should wait for actions to complete before timing out. Default is{' '}
