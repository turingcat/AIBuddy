...
interface AIBuddyDesktopInstallerProps {
  extensionId: string;
...
export default function AIBuddyDesktopInstaller({
  extensionId,
  extensionName,
  description,
  type,
  ...
  const buildAIBuddyUrl = () => {
    ...
    return `aibuddy://extension?${urlParts.join('&')}`;
  };
  ...
  return (
    <div>
      <ol>
        <li>
          <a href={buildAIBuddyUrl()}>Launch the installer</a>
        </li>
