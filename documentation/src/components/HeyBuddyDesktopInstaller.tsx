...
interface HeyBuddyDesktopInstallerProps {
  extensionId: string;
...
export default function HeyBuddyDesktopInstaller({
  extensionId,
  extensionName,
  description,
  type,
  ...
  const buildHeyBuddyUrl = () => {
    ...
    return `heybuddy://extension?${urlParts.join('&')}`;
  };
  ...
  return (
    <div>
      <ol>
        <li>
          <a href={buildHeyBuddyUrl()}>Launch the installer</a>
        </li>
