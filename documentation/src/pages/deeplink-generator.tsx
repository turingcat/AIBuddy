...
export default function DeeplinkGenerator() {
  ...
  useEffect(() => {
    ...
    if (urlParams.toString()) {
      try {
        if (urlParams.get('cmd') === 'heybuddy' && urlParams.getAll('arg').includes('mcp')) {
      ...
      <div className="container mx-auto px-4 py-8 md:p-24">
        <div className="pb-8 md:pb-16">
          ...
          <p className="text-textProminent">
            Generate installation deeplinks for heybuddy extensions that can be shared with others.
          </p>
        </div>
                  ...
                  {extensionType === 'stdio' ? (
                    <div>
                      ...
                      <input
                        ...
                        required
                        className="w-full p-3 border border-borderSubtle rounded-lg bg-bgSubtle text-textStandard"
                        placeholder="npx @heybuddyai/example-extension"
                      />
                    </div>
                  ) : (
                    <div>
          ...
          <ol className="list-decimal pl-6 space-y-2 text-textStandard">
            ...
            <li>For custom extensions:
              <ul className="list-disc pl-6 mt-2">
                ...
                <li>Choose <strong>STDIO</strong> and enter the command to run your extension (e.g. <code>npx @heybuddyai/my-ext</code>), or choose <strong>Streamable HTTP</strong> and enter the endpoint URL</li>
            ...
            <li>Copy and share the generated deeplink — when users click it, it will open heybuddy Desktop and prompt them to install your extension.</li>
          </ol>
        </div>
      </div>
    </Layout>
