...
# heybuddy in 5 minutes

heybuddy is an extensible open source AI agent that enhances your software development by automating coding tasks. 
  ...
  <TabItem value="mac" label="macOS" default>
    ...
    <Tabs groupId="interface">
      ...
      <TabItem value="cli" label="heybuddy CLI">
        Run the following command to install heybuddy:
  ...
  <TabItem value="windows" label="Windows">
    ...
    <Tabs groupId="interface">
      ...
      <TabItem value="cli" label="heybuddy CLI">
        ...
        Run the following command in **Git Bash**, **MSYS2**, or **PowerShell** to install the heybuddy CLI natively on Windows:
        ...
        If you see a PATH warning after installation, you'll need to add heybuddy to your PATH before running `heybuddy configure`. See the [Windows CLI installation instructions](/docs/getting-started/installation) for detailed steps.
...
heybuddy works with [supported LLM providers](/docs/getting-started/providers) that give heybuddy the AI intelligence it needs to understand your requests. On first use, you'll be prompted to configure your preferred provider.
...
<Tabs groupId="interface">
  ...
  heybuddy will open a browser for you to authenticate with Tetrate, or create a new account if you don't have one already. When you return to the heybuddy desktop app, you're ready to begin your first session.
...
## Start Session
Sessions are single, continuous conversations between you and heybuddy. Let's start one.

<Tabs groupId="interface">
    <TabItem value="ui" label="heybuddy Desktop" default>
        After choosing an LLM provider, click the `Home` button in the sidebar.

        Type your questions, tasks, or instructions directly into the input field, and heybuddy will immediately get to work.
    </TabItem>
    <TabItem value="cli" label="heybuddy CLI">
        1. Make an empty directory (e.g. `heybuddy-demo`) and navigate to that directory from the terminal.
...
From the prompt, you can interact with heybuddy by typing your instructions exactly as you would speak to a developer.

Let's ask heybuddy to make a tic-tac-toe game!

```
create an interactive browser-based tic-tac-toe game in javascript where a player competes against a bot
```

heybuddy will create a plan and then get right to work on implementing it. Once done, your directory should contain a JavaScript file as well as an HTML page for playing.


## Enable an Extension

While you're able to manually navigate to your working directory and open the HTML file in a browser, wouldn't it be better if heybuddy did that for you? Let's give heybuddy the ability to open a web browser by enabling the [`Computer Controller` extension](/docs/mcp/computer-controller-mcp).
...
<Tabs groupId="interface">
    ...
    <TabItem value="ui" label="heybuddy Desktop" default>
        ...
        5. Now that heybuddy has browser capabilities, let's ask it to launch your game in a browser:
    </TabItem>
    <TabItem value="cli" label="heybuddy CLI">
        ...
        ```
        4. Now that heybuddy has browser capabilities, let's resume your last session:
        ```sh
         heybuddy session -r
        ```
        5. Ask heybuddy to launch your game in a browser:
    </TabItem>
</Tabs>
...
## Next Steps
Congrats, you've successfully used heybuddy to develop a web app! 🎉

Here are some ideas for next steps:
* Continue your session with heybuddy and improve your game (styling, functionality, etc).
* Browse other available [extensions](/extensions) and install more to enhance heybuddy's functionality even further.
* Provide heybuddy with a [set of hints](/docs/guides/context-engineering/using-heybuddyhints) to use within your sessions.
* See how you can set up [access controls](/docs/mcp/developer-mcp#configuring-access-controls) if you don't want heybuddy to work autonomously.
