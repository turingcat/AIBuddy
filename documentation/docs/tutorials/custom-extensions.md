...
description: Create your own custom MCP Server to use as a heybuddy extension
---
...
:::info
heybuddy supports Tools, Resources, and Prompts from the [Model Context Protocol](https://modelcontextprotocol.io/). See [`mcp_client.rs`](https://github.com/aaif-goose/goose/blob/main/crates/goose/src/agents/mcp_client.rs) for the supported protocol version and client capabilities.
:::
...
## Step 5: Integrate with heybuddy

To add your MCP server as an extension in heybuddy:
...
2. Open heybuddy Desktop and click the <PanelLeft className="inline" size={16} /> button in the top-left to open the sidebar
...
To see any changes you make to your MCP server code after integrating with heybuddy, re-run `uv pip install .` and then restart heybuddy Desktop.
:::
...
## Step 6: Use Your Extension in heybuddy

Once integrated, you can start using your extension in heybuddy. Open the heybuddy chat interface and call your tool as needed.

You can verify that heybuddy has picked up the tools from your custom extension by asking it "what tools do you have?"

![heybuddy Chat - Ask about tools](../assets/guides/custom-extension-tools.png)

Then, you can try asking questions that require using the extension you added.

![heybuddy Chat - Use custom extension](../assets/guides/custom-extension-chat.png)

🎉 **Congratulations!** You’ve successfully built and integrated a custom MCP server with heybuddy.

---

## Advanced Features for MCP Extensions

heybuddy supports advanced MCP features that can enhance your extensions.

### MCP Sampling: AI-Powered Tools

**[MCP Sampling](/docs/guides/mcp-sampling)** allows your MCP servers to request AI completions from heybuddy's LLM, transforming simple tools into intelligent agents.
...
- [heybuddy's implementation](https://github.com/aaif-goose/goose/blob/main/crates/goose/src/agents/mcp_client.rs) currently supports text and image content types
- heybuddy automatically advertises sampling capability to all MCP servers
...
- Components render securely in isolated sandboxes within heybuddy Desktop
