...
description: Create your own custom MCP Server to use as a aibuddy extension
---
...
:::info
aibuddy supports Tools, Resources, and Prompts from the [Model Context Protocol](https://modelcontextprotocol.io/). See [`mcp_client.rs`](https://github.com/aaif-goose/goose/blob/main/crates/goose/src/agents/mcp_client.rs) for the supported protocol version and client capabilities.
:::
...
## Step 5: Integrate with aibuddy

To add your MCP server as an extension in aibuddy:
...
2. Open aibuddy Desktop and click the <PanelLeft className="inline" size={16} /> button in the top-left to open the sidebar
...
To see any changes you make to your MCP server code after integrating with aibuddy, re-run `uv pip install .` and then restart aibuddy Desktop.
:::
...
## Step 6: Use Your Extension in aibuddy

Once integrated, you can start using your extension in aibuddy. Open the aibuddy chat interface and call your tool as needed.

You can verify that aibuddy has picked up the tools from your custom extension by asking it "what tools do you have?"

![aibuddy Chat - Ask about tools](../assets/guides/custom-extension-tools.png)

Then, you can try asking questions that require using the extension you added.

![aibuddy Chat - Use custom extension](../assets/guides/custom-extension-chat.png)

🎉 **Congratulations!** You’ve successfully built and integrated a custom MCP server with aibuddy.

---

## Advanced Features for MCP Extensions

aibuddy supports advanced MCP features that can enhance your extensions.

### MCP Sampling: AI-Powered Tools

**[MCP Sampling](/docs/guides/mcp-sampling)** allows your MCP servers to request AI completions from aibuddy's LLM, transforming simple tools into intelligent agents.
...
- [aibuddy's implementation](https://github.com/aaif-goose/goose/blob/main/crates/goose/src/agents/mcp_client.rs) currently supports text and image content types
- aibuddy automatically advertises sampling capability to all MCP servers
...
- Components render securely in isolated sandboxes within aibuddy Desktop
