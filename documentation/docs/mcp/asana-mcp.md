...
description: Add Asana MCP Server as a heybuddy Extension
---
...
This tutorial covers how to add the [Asana MCP Server](https://github.com/roychri/mcp-server-asana) as a heybuddy extension to enable task automation, project tracking, and team collaboration.
...
> _heybuddy, I have one hour. Look through uncompleted tasks assigned to me in Asana and show me ones that you estimate will take an hour or less. Order them by deadline._
