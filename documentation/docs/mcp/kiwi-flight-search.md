...
description: Add Kiwi Flight Search MCP Server as a aibuddy Extension
unlisted: true
---
...
This tutorial covers how to add the [Kiwi Flight Search MCP Server](https://mcp.kiwi.com) as a aibuddy extension to enable flight search and price comparison.
