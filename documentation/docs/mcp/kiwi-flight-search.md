...
description: Add Kiwi Flight Search MCP Server as a heybuddy Extension
unlisted: true
---
...
This tutorial covers how to add the [Kiwi Flight Search MCP Server](https://mcp.kiwi.com) as a heybuddy extension to enable flight search and price comparison.
