...
description: Add AgentQL MCP Server as a aibuddy Extension
---
...
This tutorial covers how to add the [AgentQL MCP Server](https://github.com/tinyfish-io/agentql-mcp) as a aibuddy extension to extract and transform unstructured web content into structured data.
