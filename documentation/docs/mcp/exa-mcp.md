...
description: Add Exa MCP Server as a heybuddy Extension
---
...
This tutorial covers how to add the [Exa MCP Server](https://github.com/exa-labs/exa-mcp-server) as a heybuddy extension to enable AI-powered web search functionality.
...
The Exa MCP server enables AI-powered web search in your heybuddy interactions. Exa offers advanced search capabilities including:
