...
description: Add MongoDB MCP Server as a heybuddy Extension
---
...
Just describe what you want to accomplish in natural language, and heybuddy will help you execute the appropriate MongoDB operations safely and efficiently.
