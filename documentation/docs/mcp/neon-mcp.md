...
description: Add Neon MCP Server as a heybuddy Extension
---
...
This tutorial covers how to add the [Neon MCP Server](https://github.com/neondatabase/mcp-server-neon) as a heybuddy extension to interact with your Neon Postgres databases and manage your projects, branches, and more.
