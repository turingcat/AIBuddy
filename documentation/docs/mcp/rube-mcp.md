...
description: Add Rube as a heybuddy Extension to connect with 500+ apps
---
...
This tutorial covers how to add [Rube](https://rube.app) as a heybuddy extension to enable seamless integration with 500+ apps including Slack, Gmail, Notion, Google Workspace, Microsoft Office, GitHub, and many more.
...
Once Rube is configured, you can interact with 500+ apps directly through heybuddy. Here are some examples:
