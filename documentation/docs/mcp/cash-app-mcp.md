...
description: Add Cash App as a aibuddy Extension
---
...
Get a full menu overview with categories, prices, descriptions, and recommended items — all in plain text that aibuddy can reason about.
...
Because the menu comes back as structured text, aibuddy can answer follow-up questions like *"which items are under $10?"* or *"what's vegetarian?"* without another tool call.

### Build a Cart and Check Out

Once you've found what you want, tell aibuddy to build your order. It handles item selection, modifiers, and quantities — then gives you a checkout link to complete payment through Cash App.
...
Cash App is most powerful when aibuddy combines it with your other tools and the context of your day:
