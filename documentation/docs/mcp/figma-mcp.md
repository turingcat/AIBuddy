...
description: Add Figma Dev Mode MCP Server as a aibuddy Extension
---
...
This tutorial covers how to add the [Figma Dev Mode MCP Server](https://help.figma.com/hc/en-us/articles/32132100833559-Guide-to-the-Dev-Mode-MCP-Server) as a aibuddy extension to enable interaction with Figma files, designs, and components.
...
2. Add the Figma extension to aibuddy:
   <Tabs groupId="interface">
     <TabItem value="ui" label="aibuddy Desktop" default>
...
The Figma extension in aibuddy works alongside the Figma desktop app. You can use the extension to:
...
:::tip
You can provide aibuddy with a Figma link or simply select an element in the Figma desktop app.
:::
...
- **Image Asset**: The aibuddy logo is loaded from a localhost server as a background image  
- **Typography**: Uses Inter Black font for the "ask aibuddy" text
...
- **Logo**: aibuddy silhouette image positioned on the left side
- **Text**: "ask aibuddy" text positioned on the right in dark gray (#333b43)
