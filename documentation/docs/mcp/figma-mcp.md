...
description: Add Figma Dev Mode MCP Server as a heybuddy Extension
---
...
This tutorial covers how to add the [Figma Dev Mode MCP Server](https://help.figma.com/hc/en-us/articles/32132100833559-Guide-to-the-Dev-Mode-MCP-Server) as a heybuddy extension to enable interaction with Figma files, designs, and components.
...
2. Add the Figma extension to heybuddy:
   <Tabs groupId="interface">
     <TabItem value="ui" label="heybuddy Desktop" default>
...
The Figma extension in heybuddy works alongside the Figma desktop app. You can use the extension to:
...
:::tip
You can provide heybuddy with a Figma link or simply select an element in the Figma desktop app.
:::
...
- **Image Asset**: The heybuddy logo is loaded from a localhost server as a background image  
- **Typography**: Uses Inter Black font for the "ask heybuddy" text
...
- **Logo**: heybuddy silhouette image positioned on the left side
- **Text**: "ask heybuddy" text positioned on the right in dark gray (#333b43)
