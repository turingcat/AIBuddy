...
description: Add PDF Reader MCP Server as a heybuddy Extension
---
...
This tutorial covers how to add the [PDF Reader MCP Server](https://github.com/michaelneale/mcp-read-pdf) as a heybuddy extension, enabling heybuddy to read and extract text from protected and unprotected PDFs.
...
This example shows how to use the PDF Reader Extension to analyze an applicant's resume for specific attributes. With the PDF Reader extension, heybuddy can read specific pages or entire documents as well as extract text from large and complex PDFs.
