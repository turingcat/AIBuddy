...
description: Add Vercel MCP Server as a heybuddy Extension for managing your deployments
---
...
This tutorial covers how to add the [Vercel MCP Server](https://vercel.com/docs/mcp/vercel-mcp) as a heybuddy extension to manage your Vercel projects and deployment status directly from heybuddy.
