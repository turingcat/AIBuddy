...
description: Add Cloudflare MCP Servers as heybuddy Extensions
unlisted: true
---
...
This tutorial covers how to add [Cloudflare's MCP Servers](https://github.com/cloudflare/mcp-server-cloudflare) as heybuddy extensions to manage your Cloudflare infrastructure, debug applications, analyze traffic, and more using natural language.
...
### Step 2: Add MCP Server to heybuddy
...
[heybuddy uses the observability MCP server to fetch error logs]
...
With Cloudflare MCP servers enabled in heybuddy, you can:
