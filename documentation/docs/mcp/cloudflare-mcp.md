...
description: Add Cloudflare MCP Servers as aibuddy Extensions
unlisted: true
---
...
This tutorial covers how to add [Cloudflare's MCP Servers](https://github.com/cloudflare/mcp-server-cloudflare) as aibuddy extensions to manage your Cloudflare infrastructure, debug applications, analyze traffic, and more using natural language.
...
### Step 2: Add MCP Server to aibuddy
...
[aibuddy uses the observability MCP server to fetch error logs]
...
With Cloudflare MCP servers enabled in aibuddy, you can:
