...
description: Add Blender MCP Server as a aibuddy Extension
---
...
This tutorial covers how to add the [Blender MCP Server](https://github.com/ahujasid/blender-mcp) as a aibuddy extension to create 3D scenes, control Blender with natural language, generate models, apply materials, and more.
...
In this example, I’ll show you how to use aibuddy with the Blender Extension to build an entire 3D campfire scene from scratch. By automating Blender controls through natural language, aibuddy can create objects like logs and fireballs, apply realistic materials, add lighting effects, generate particles for sparks, create subtle smoke, and even animate the fire to gently pulse over time.

In this example, I’ll show you how to use aibuddy with the Blender Extension to build a full 3D campfire scene, including logs, fireballs, lighting, and subtle fire animation, just by describing what you want.
