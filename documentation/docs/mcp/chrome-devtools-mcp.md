...
description: Add Chrome DevTools MCP Server as a aibuddy Extension
---
...
This tutorial covers how to add the Chrome DevTools MCP Server as a aibuddy extension to enable browser automation, web performance testing, and interactive web application debugging in a Chrome browser.
...
In this example, I'll show you how to use aibuddy with the Chrome DevTools Extension to perform automated performance testing on a demo website.
