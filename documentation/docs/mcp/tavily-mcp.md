...
description: Add Tavily MCP Server as a aibuddy Extension
---
...
This tutorial covers how to add the [Tavily Web Search MCP Server](https://github.com/tavily-ai/tavily-mcp) as a aibuddy extension to enable AI-powered web search functionality.
...
The Tavily MCP server enables AI-powered web search functionality in your aibuddy interactions. When you obtain your API key, you'll have access to Tavily's advanced search capabilities including:
