...
description: Add Excalidraw MCP App as a heybuddy Extension
---
...
This tutorial covers how to add the [Excalidraw MCP App](https://github.com/excalidraw/excalidraw-mcp) as a heybuddy extension that enables heybuddy to draw hand sketched Excalidraw diagrams in real time.
...
In this example, we use the Excalidraw MCP App to have HeyBuddy visualize its own automation pipeline in real time. This demonstrates how HeyBuddy can connect to live tools, reason about workflows, and generate structured diagrams element by element.

### heybuddy Prompt
```
Hey HeyBuddy review my video automation recipe and create a visual of the automation pipeline for me. I want clean lines and clear labels.
```
