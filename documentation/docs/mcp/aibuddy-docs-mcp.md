---
title: aibuddy Docs Extension

description: Add aibuddy Docs MCP Server as a aibuddy Extension
---
...
This tutorial covers how to add the [aibuddy Docs MCP Server](https://github.com/idosal/git-mcp) as a aibuddy extension to enable aibuddy to answer questions about itself.

:::tip Quick Install
<Tabs groupId="interface">
  <TabItem value="ui" label="aibuddy Desktop" default>
  [Launch the installer](goose://extension?cmd=npx&arg=mcp-remote&arg=https%3A%2F%2Fblock.gitmcp.io%2Faibuddy%2F&id=aibuddy-docs&name=aibuddy%20Docs&description=gitmcp%20for%20aibuddy%20documentation)
  </TabItem>
...
<Tabs groupId="interface">
  <TabItem value="ui" label="aibuddy Desktop" default>
    <AIBuddyDesktopInstaller
      extensionId="aibuddy-docs"
      extensionName="aibuddy Docs"
      description="GitMCP for aibuddy documentation"
      command="npx"
...
## Example Usage
GitMCP allows you to convert any Git repository into a aibuddy extension. The aibuddy Docs MCP Server is a great example of this, as it provides a way for aibuddy to answer questions about itself.

Let's ask aibuddy to create a recipe for us! It will use the aibuddy Docs MCP Server to find the relevant information.


### aibuddy Prompt

```
hey aibuddy, I want to create a recipe for automated code review that my development team can use. Can you look at the aibuddy documentation to understand the recipe format, then create a recipe that:
...
Please research the recipe format first using the aibuddy Docs extension, then create a complete recipe file with proper YAML structure, parameters, and any needed extensions. 
...
Perfect! I've created a comprehensive automated code review recipe based on the aibuddy documentation research. Here's what I've built for your development team:
...
#### Basic Usage:
```bash
aibuddy run automated-code-review.yaml \
...
- Proper YAML structure following aibuddy recipe format
    ...
    properties:
      ...
      ci_cd_metadata:
        ...
        properties:
          ...
          reviewer:
            type: string
            description: "aibuddy automated code review"
          language:
            type: string
