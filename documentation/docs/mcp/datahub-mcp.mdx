...
description: Add DataHub MCP Server as a heybuddy Extension
---
...
This tutorial covers how to add the [DataHub MCP Server](https://github.com/acryldata/mcp-server-datahub) as a heybuddy extension to enable AI-powered data discovery, lineage exploration, and metadata querying across your data ecosystem.
