...
description: Add Nano Banana MCP Server as a heybuddy Extension
---
...
This tutorial covers how to add the [Nano Banana MCP Server](https://github.com/ConechoAI/Nano-Banana-MCP) as a heybuddy extension that provides AI image generation and editing capabilities using Google's Gemini Image API.
...
With Nano Banana, you can generate new images and edit existing images in natural language.  Simply describe what you want created or modified and heybuddy will turn that into a detailed prompt to provide to Nano Banana.
