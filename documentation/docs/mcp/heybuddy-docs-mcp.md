---
title: heybuddy Docs Extension

description: Add heybuddy Docs MCP Server as a heybuddy Extension
---
...
This tutorial covers how to add the [heybuddy Docs MCP Server](https://github.com/idosal/git-mcp) as a heybuddy extension to enable heybuddy to answer questions about itself.

:::tip Quick Install
<Tabs groupId="interface">
  <TabItem value="ui" label="heybuddy Desktop" default>
  [Launch the installer](goose://extension?cmd=npx&arg=mcp-remote&arg=https%3A%2F%2Fblock.gitmcp.io%2Fheybuddy%2F&id=heybuddy-docs&name=heybuddy%20Docs&description=gitmcp%20for%20heybuddy%20documentation)
  </TabItem>
...
<Tabs groupId="interface">
  <TabItem value="ui" label="heybuddy Desktop" default>
    <HeyBuddyDesktopInstaller
      extensionId="heybuddy-docs"
      extensionName="heybuddy Docs"
      description="GitMCP for heybuddy documentation"
      command="npx"
...
## Example Usage
GitMCP allows you to convert any Git repository into a heybuddy extension. The heybuddy Docs MCP Server is a great example of this, as it provides a way for heybuddy to answer questions about itself.

Let's ask heybuddy to create a recipe for us! It will use the heybuddy Docs MCP Server to find the relevant information.


### heybuddy Prompt

```
hey heybuddy, I want to create a recipe for automated code review that my development team can use. Can you look at the heybuddy documentation to understand the recipe format, then create a recipe that:
...
Please research the recipe format first using the heybuddy Docs extension, then create a complete recipe file with proper YAML structure, parameters, and any needed extensions. 
...
Perfect! I've created a comprehensive automated code review recipe based on the heybuddy documentation research. Here's what I've built for your development team:
...
#### Basic Usage:
```bash
heybuddy run automated-code-review.yaml \
...
- Proper YAML structure following heybuddy recipe format
    ...
    properties:
      ...
      ci_cd_metadata:
        ...
        properties:
          ...
          reviewer:
            type: string
            description: "heybuddy automated code review"
          language:
            type: string
