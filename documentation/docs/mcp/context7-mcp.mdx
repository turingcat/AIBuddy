...
description: Add Context7 MCP Server as a heybuddy Extension
---
...
This tutorial covers how to add the [Context7 MCP Server](https://github.com/upstash/context7) as a heybuddy extension to pull up-to-date, version-specific code and docs so heybuddy can vibe code with real context, not hallucinated or outdated answers.
...
In this example, heybuddy uses Context7 to pull real-time docs, compare tools, and scaffold a modern app using only the latest, official implementation patterns.
