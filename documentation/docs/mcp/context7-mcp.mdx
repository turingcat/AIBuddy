...
description: Add Context7 MCP Server as a aibuddy Extension
---
...
This tutorial covers how to add the [Context7 MCP Server](https://github.com/upstash/context7) as a aibuddy extension to pull up-to-date, version-specific code and docs so aibuddy can vibe code with real context, not hallucinated or outdated answers.
...
In this example, aibuddy uses Context7 to pull real-time docs, compare tools, and scaffold a modern app using only the latest, official implementation patterns.
