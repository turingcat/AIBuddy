...
import IconHeyBuddy from "@site/src/components/icons/heybuddy";

The [heybuddy for VS Code extension](https://marketplace.visualstudio.com/items?itemName=block.vscode-goose) lets you interact with heybuddy directly within VS Code.

:::warning Experimental Feature
heybuddy for VS Code is in active development. Behavior and configuration may change in future releases.
:::

The extension uses the [Agent Client Protocol (ACP)](/docs/guides/acp-clients) to communicate with heybuddy.

## Install the Extension

:::info Prerequisites
- [VS Code](https://code.visualstudio.com/) version 1.95.0 or higher
- [heybuddy CLI](/docs/getting-started/installation)
:::
...
5. Click the <IconHeyBuddy className="inline" size={16} /> icon in the Activity Bar to open the side panel and start chatting with heybuddy

## Share Context with heybuddy

There are two ways to provide context to heybuddy.

### Send Selected Code

1. Select the code you want to discuss in your editor
2. Send the selection to heybuddy:
   - macOS: `Cmd+Shift+G`
   - Windows/Linux: `Ctrl+Shift+G`
   - Right-click and choose `Send to heybuddy`
...
The heybuddy for VS Code extension connects directly to your editor, letting you manage files, projects, and workflows with AI. It includes the following features:

- Interactive chat UI with streaming responses
- Access to heybuddy's AI capabilities and enabled extensions
...
```
Update the contributing guide at /heybuddy/CONTRIBUTING.md with instructions on how to start docusaurus dev server
```
