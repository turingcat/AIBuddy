...
import IconAIBuddy from "@site/src/components/icons/aibuddy";

The [aibuddy for VS Code extension](https://marketplace.visualstudio.com/items?itemName=block.vscode-goose) lets you interact with aibuddy directly within VS Code.
...
- [aibuddy CLI](/docs/getting-started/installation)
:::
...
5. Click the <IconAIBuddy className="inline" size={16} /> icon in the Activity Bar to open the side panel and start chatting with aibuddy

## Share Context with aibuddy

There are two ways to provide context to aibuddy.

### Send Selected Code

1. Select the code you want to discuss in your editor
2. Send the selection to aibuddy:
   - macOS: `Cmd+Shift+G`
   - Windows/Linux: `Ctrl+Shift+G`
   - Right-click and choose `Send to aibuddy`
...
The aibuddy for VS Code extension connects directly to your editor, letting you manage files, projects, and workflows with AI. It includes the following features:

- Interactive chat UI with streaming responses
- Access to aibuddy's AI capabilities and enabled extensions
...
```
Update the contributing guide at /aibuddy/CONTRIBUTING.md with instructions on how to start docusaurus dev server
```
