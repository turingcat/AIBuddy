...
<p className={styles.pageDescription}>
  aibuddy is an open source project that is constantly being improved and expanded upon. These experimental features and projects are still in development and may not be fully stable or ready for production use, but they showcase exciting possibilities for the future of AI automation.
</p>

:::note
The list of experimental features may change as aibuddy development progresses. Some features may be promoted to stable features, while others might be modified or removed. This section will be updated with specific experimental features as they become available.
:::
...
<div className={styles.categorySection}>
  ...
  <div className={styles.cardGrid}>
    ...
    <Card 
      title="Remote Access"
      description="Access aibuddy remotely via the aibuddy AI mobile app or messaging platforms like Telegram."
      link="/docs/experimental/remote-access"
    />
    <Card 
      title="aibuddy for VS Code Extension"
...
<div className={styles.categorySection}>
  ...
  <div className={styles.cardGrid}>
    ...
    />
    <Card 
      title="AI, But Make It Local With aibuddy and Ollama"
      description="Learn how to integrate aibuddy with Ollama for a fully local AI experience, including structured outputs and tool calling capabilities."
      link="/blog/2025/03/14/aibuddy-ollama"
    />
    <Card 
      title="Community-Inspired Benchmarking: The aibuddy Vibe Check"
      description="See how open source AI models measure up in our first aibuddy agent benchmark tests, including toolshim performance analysis."
      link="/blog/2025/03/31/aibuddy-benchmark"
    />
  </div>
</div>
