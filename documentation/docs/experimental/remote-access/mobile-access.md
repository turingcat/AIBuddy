...
description: Mobile access via secure tunneling is no longer available in aibuddy Desktop.
unlisted: true
---

Mobile access via secure tunneling is no longer available in current aibuddy Desktop builds.
