...
aibuddy is designed to be forked and customized. You can create your own "distro" of aibuddy preconfigured with specific providers, bundled extensions, custom branding, and tailored workflows for your organization or audience.
...
- **Architecture overview** — how aibuddy's layers (UI → server → core) fit together
...
- **Building new interfaces** — integrating with `aibuddy serve` or `aibuddy acp` over Agent Client Protocol (ACP)
...
## Quick example: ship aibuddy with a local model
