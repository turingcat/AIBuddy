...
description: Personalize how you navigate aibuddy Desktop by changing the sidebar's look, position, and behavior
---

import { PanelLeft, Menu } from 'lucide-react';

:::info Desktop Only
Sidebar customization is available only in aibuddy Desktop.
:::

The sidebar is how you navigate between pages in aibuddy Desktop: Home, Chat, Recipes, Apps, Scheduler, Extensions, and Settings. You can customize its appearance, position, and behavior to fit the way you work.
