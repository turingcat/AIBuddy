...
hide_title: true
description: Build interactive UI applications that render inside heybuddy Desktop using MCP Apps
---
...
<p className={styles.pageDescription}>
  heybuddy Desktop supports extensions that transform text-only responses into
...
<div className={styles.categorySection}>
  ...
  <div className={styles.cardGrid}>
    <Card
      ...
      description="Step-by-step tutorial to create interactive UI applications that render inside heybuddy Desktop."
      link="/docs/tutorials/building-mcp-apps"
    />
    <Card
      title="Using MCP Apps"
      description="Launch standalone apps and render interactive UI directly in heybuddy Desktop conversations."
      link="/docs/guides/interactive-chat/mcp-ui"
    />
    <Card
      title="Auto Visualiser Extension"
      description="Generate interactive data visualizations automatically in heybuddy."
    ...
    videos={[
      {
        ...
        description:
          "What MCP Apps are and how they render interactive UIs in heybuddy",
        duration: "1:53",
      },
    ]}
  />
...
<div className={styles.categorySection}>
  ...
  <div className={styles.cardGrid}>
    ...
    />
    <Card
      title="heybuddy Lands MCP Apps"
      description="heybuddy ships early support for the draft MCP Apps specification, aligning with the emerging standard for interactive UIs."
