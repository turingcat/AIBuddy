...
hide_title: true
description: Build interactive UI applications that render inside aibuddy Desktop using MCP Apps
---
...
<p className={styles.pageDescription}>
  aibuddy Desktop supports extensions that transform text-only responses into
...
<div className={styles.categorySection}>
  ...
  <div className={styles.cardGrid}>
    <Card
      ...
      description="Step-by-step tutorial to create interactive UI applications that render inside aibuddy Desktop."
      link="/docs/tutorials/building-mcp-apps"
    />
    <Card
      title="Using MCP Apps"
      description="Launch standalone apps and render interactive UI directly in aibuddy Desktop conversations."
      link="/docs/guides/interactive-chat/mcp-ui"
    />
    <Card
      title="Auto Visualiser Extension"
      description="Generate interactive data visualizations automatically in aibuddy."
    ...
    videos={[
      {
        ...
        description:
          "What MCP Apps are and how they render interactive UIs in aibuddy",
        duration: "1:53",
      },
    ]}
  />
...
<div className={styles.categorySection}>
  ...
  <div className={styles.cardGrid}>
    ...
    />
    <Card
      title="aibuddy Lands MCP Apps"
      description="aibuddy ships early support for the draft MCP Apps specification, aligning with the emerging standard for interactive UIs."
