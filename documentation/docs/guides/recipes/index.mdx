...
<div className={styles.categorySection}>
  ...
  <div className={styles.cardGrid}>
    ...
    <Card 
      ...
      description="Complete technical reference for creating and customizing recipes in aibuddy via the CLI."
    ...
    />
    <Card 
      title="aibuddy Recipes Tutorial"
      description="Learn how to create and use aibuddy recipes with prompts, parameters, MCP servers, and more."
    ...
    <Card 
      ...
      description="Learn how to save, organize, and find your aibuddy recipes for easy access and reuse."
...
<VideoCarousel
  ...
  videos={[
    { 
      ...
      title: 'Advanced Tips for Recipes/Subrecipes in aibuddy',
      description: 'Advanced tips for using recipes and subrecipes in aibuddy',
      duration: '10:07'
    },
    { 
      type: 'iframe', 
      src: 'https://youtube.com/embed/gvg7DomaJuA',
      title: 'Headless aibuddy, Scheduling a Parallel-Subagent Recipe',
