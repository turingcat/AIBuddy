...
<div className={styles.categorySection}>
  ...
  <div className={styles.cardGrid}>
    ...
    <Card 
      ...
      description="Complete technical reference for creating and customizing recipes in heybuddy via the CLI."
    ...
    />
    <Card 
      title="heybuddy Recipes Tutorial"
      description="Learn how to create and use heybuddy recipes with prompts, parameters, MCP servers, and more."
    ...
    <Card 
      ...
      description="Learn how to save, organize, and find your heybuddy recipes for easy access and reuse."
...
<VideoCarousel
  ...
  videos={[
    { 
      ...
      title: 'Advanced Tips for Recipes/Subrecipes in heybuddy',
      description: 'Advanced tips for using recipes and subrecipes in heybuddy',
      duration: '10:07'
    },
    { 
      type: 'iframe', 
      src: 'https://youtube.com/embed/gvg7DomaJuA',
      title: 'Headless heybuddy, Scheduling a Parallel-Subagent Recipe',
