...
<p className={styles.pageDescription}>
  heybuddy supports several approaches for using different models within a single session, allowing you to optimize for cost, performance, and task specialization. Strategies range from manual or turn-based model selection to dynamic, context-aware switching.
</p>
...
<div className={styles.categorySection}>
  ...
  <div className={styles.cardGrid}>
    <Card
      ...
      link="/blog/2025/06/16/multi-model-in-heybuddy"
    />
    <Card
...
<VideoCarousel
  ...
  videos={[
    { 
      ...
      title: 'heybuddy\'s Multi-Model Setup',
      description: 'Learn practical multi-model workflows in heybuddy',
      duration: '5:01'
    }
  ]}
/>
