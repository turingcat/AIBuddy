...
The adversary uses the same model and provider aibuddy is already configured with. No additional API keys or services needed.

## Enabling Adversary Mode

Create a file at `~/.config/aibuddy/adversary.md` with your rules:
