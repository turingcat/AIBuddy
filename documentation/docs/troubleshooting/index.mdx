...
hide_title: true
description: Get help, report issues, and troubleshoot common problems with heybuddy.
---
...
<p className={styles.pageDescription}>
  Get help when you need it, report bugs, request features, and find solutions to common issues. heybuddy provides built-in diagnostics and direct links to our support channels.
</p>
...
<div className={styles.categorySection}>
  ...
  <div className={styles.cardGrid}>
    ...
    <Card
      ...
      description="Find the desktop startup diagnostics log, understand the key fields, and attach the right artifacts when heybuddy fails before the backend becomes ready."
    ...
    <Card 
      title="Logs"
      description="Learn how to access and interpret heybuddy session logs and system logs for debugging and troubleshooting purposes."
...
<div className={styles.categorySection}>
  ...
  <div className={styles.cardGrid}>
    <Card 
      ...
      description="Join our active Discord server for real-time help, discussions, and community support from heybuddy users and maintainers."
